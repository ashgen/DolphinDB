...
vector <ConstantSP> vals = {boolval, charval, intval, shortval, longval, floatval, doubleval, stringval, symbolval,
                            blobval, int128val,
                            ipval, uuidval, dateval, monthval, timeval, minuteval, secondval, datetimeval, timestampval,
                            nanotimeval, nanotimestampval};
vector <string> names = {"boolval", "charval", "intval", "shortval", "longval", "floatval", "doubleval", "stringval",
                         "symbolval", "blobval", "int128val",
                         "ipval", "uuidval", "dateval", "monthval", "timeval", "minuteval", "secondval", "datetimeval",
                         "timestampval", "nanotimeval", "nanotimestampval"};
conn.
upload(names, vals
);
for (
...
EXPECT_ANY_THROW(Guid
err = new Guid(erruuid)
);
EXPECT_ANY_THROW(Guid
err = new Guid(erruuid1)
);
...
EXPECT_EQ(Guid::getString(uuid), Util::parseConstant(DT_UUID, uuidval.getString())
->
...
EXPECT_ANY_THROW(ConstantSP
decimalval1 = Util::createDecimal32(10, 3.1626)
);//scale + value's places must less than 10
...
EXPECT_ANY_THROW(ConstantSP
decimalval2 = Util::createDecimal64(19, 13.1626)
);//scale + value's places must less than 19
...
decimalval1->
assign(Util::createDecimal32(2, 1.34567)
);
decimalval2->
assign(Util::createDecimal32(2, 1.34567)
);
...
"1.34000000000000000");
EXPECT_ANY_THROW(decimalval1
->
assign(Util::createDecimal64(0, -1000000000000000000)
));
EXPECT_ANY_THROW(decimalval1
->
assign(Util::createDecimal64(0, 1000000000000000000)
...
decimalval1->
assign(Util::createDecimal32(8, 2.3641553)
);
decimalval2->
assign(Util::createDecimal64(17, 2.3641553)
);
EXPECT_EQ(decimalval1
->
...
"2.36415530");
EXPECT_FLOAT_EQ(decimalval2
->

getFloat(),

float(2.36415530000000000));// result is 2.36415530000000032
...
"2.00000000000000000");
decimalval1->
assign(Util::createFloat((float) 3.1315)
);
decimalval2->
assign(Util::createFloat((float) 3.1315)
);
EXPECT_NEAR(decimalval1
->

getFloat(),

(float) 3.1315, 4);
EXPECT_NEAR(decimalval2
->
...
"-3.13154400000000000");
    ...
    decimalval1->assign(Util::createInt(1));
EXPECT_EQ(decimalval1
->compare(0, Util::createInt(0)), 1);
EXPECT_EQ(decimalval1
->compare(0, Util::createInt(2)), -1);
EXPECT_EQ(decimalval1
->compare(0, Util::createInt(1)), 0);
EXPECT_EQ(decimalval1
->compare(0, Util::createDecimal32(3, 0.99)), 1);
EXPECT_EQ(decimalval1
->compare(0, Util::createDecimal32(2, 2.01)), -1);
EXPECT_EQ(decimalval1
->compare(0, Util::createDecimal32(1, 1)), 0);
EXPECT_EQ(decimalval1
->compare(0, Util::createDecimal64(8, 0.999999999)), 1);
EXPECT_EQ(decimalval1
->compare(0, Util::createDecimal64(10, 2.00001)), -1);
EXPECT_EQ(decimalval1
->compare(0, Util::createDecimal64(1, 1)), 0);
EXPECT_ANY_THROW(decimalval1
...
EXPECT_EQ(decimalval3
->getInstance()->getString(), decimalval3->

getString()

);
EXPECT_EQ(decimalval4
->getValue()->getString(), decimalval4->
...
EXPECT_EQ(voidval
->compare(0,
Util::createNullConstant(DT_VOID)
), 0);
...
1);
    bool flag = false;
EXPECT_FALSE(voidval
->releaseMemory((long long) 1, flag));
...
->getDouble(0, 1, buf6));
EXPECT_FALSE(voidval
->getSymbol(0, 1, buf2, symbase, false));
EXPECT_TRUE(voidval
->getString(0, 1, buf8));
EXPECT_FALSE(voidval
->getString(0, 1, buf9));
EXPECT_FALSE(voidval
->getBinary(0, 1, 1, buf10));
EXPECT_FALSE(voidval
->getHash(0, 1, buckets, buf2));
cout << voidval->

getAllocatedMemory();

EXPECT_EQ(voidval
->getBoolConst(0, 1, buf)[0], CHAR_MIN);
EXPECT_EQ(voidval
->getCharConst(0, 1, buf)[0], CHAR_MIN);
EXPECT_EQ(voidval
->getShortConst(0, 1, buf1)[0], SHRT_MIN);
EXPECT_EQ(voidval
->getIntConst(0, 1, buf2)[0], INT_MIN);
EXPECT_EQ(voidval
->getLongConst(0, 1, buf3)[0], LLONG_MIN);
EXPECT_EQ(voidval
->getIndexConst(0, 1, buf4)[0], INT_MIN);
EXPECT_EQ(voidval
->getFloatConst(0, 1, buf5)[0], FLT_NMIN);
EXPECT_EQ(voidval
->getDoubleConst(0, 1, buf6)[0], DBL_NMIN);
EXPECT_ANY_THROW(voidval
->getSymbolConst(0, 1, buf2, symbase, false));
EXPECT_EQ(*(voidval
->getStringConst(0, 1, buf8)[0]), "");
EXPECT_ANY_THROW(voidval
->getStringConst(0, 1, buf9));
EXPECT_ANY_THROW(voidval
->getBinaryConst(0, 1, 1, buf10));

EXPECT_EQ(voidval
->getBoolBuffer(0, 1, buf)[0], CHAR_MIN);
EXPECT_EQ(voidval
->getCharBuffer(0, 1, buf)[0], CHAR_MIN);
EXPECT_EQ(voidval
->getShortBuffer(0, 1, buf1)[0], SHRT_MIN);
cout << voidval->getIntBuffer(0, 1, buf2) <<
endl;
    EXPECT_EQ(buf2[0], INT_MIN);
EXPECT_EQ(voidval
->getLongBuffer(0, 1, buf3)[0], LLONG_MIN);
EXPECT_EQ(voidval
->getIndexBuffer(0, 1, buf4)[0], INT_MIN);
EXPECT_EQ(voidval
->getFloatBuffer(0, 1, buf5)[0], FLT_NMIN);
EXPECT_EQ(voidval
->getDoubleBuffer(0, 1, buf6)[0], DBL_NMIN);
...
<<
endl;
EXPECT_ANY_THROW(stringval
->getBoolConst(0, 1, buf)[0]);
EXPECT_ANY_THROW(stringval
->getCharConst(0, 1, buf)[0]);
EXPECT_ANY_THROW(stringval
->getShortConst(0, 1, buf1)[0]);
EXPECT_ANY_THROW(stringval
->getIntConst(0, 1, buf2)[0]);
EXPECT_ANY_THROW(stringval
->getLongConst(0, 1, buf3)[0]);
EXPECT_ANY_THROW(stringval
->getIndexConst(0, 1, buf4)[0]);
EXPECT_ANY_THROW(stringval
->getFloatConst(0, 1, buf5)[0]);
EXPECT_ANY_THROW(stringval
->getDoubleConst(0, 1, buf6)[0]);
EXPECT_ANY_THROW(stringval
->getSymbolConst(0, 1, buf2, symbase, false));
EXPECT_EQ(*(stringval
->getStringConst(0, 1, buf8)[0]), "this is a string scalar");
EXPECT_STREQ(*(stringval
->getStringConst(0, 24, buf9)), "this is a string scalar");
EXPECT_ANY_THROW(stringval
->getBinaryConst(0, 1, 1, buf10));
...
EXPECT_EQ(val
->getBoolConst(0, 1, buf)[0], 1);
EXPECT_EQ(val
->getCharConst(0, 1, buf)[0], '\xA0');
// EXPECT_EQ(val->getShortConst(0,1,buf1)[0], SHRT_MIN);
EXPECT_EQ(val
->getIntConst(0, 1, buf2)[0], (int) 100000);
EXPECT_EQ(val
->getLongConst(0, 1, buf3)[0], (long long) 100000);
EXPECT_EQ(val
->getIndexConst(0, 1, buf4)[0], (INDEX) 100000);
EXPECT_EQ(val
->getFloatConst(0, 1, buf5)[0], (float) 100000);
EXPECT_EQ(val
->getDoubleConst(0, 1, buf6)[0], (double) 100000);
EXPECT_ANY_THROW(val
->getSymbolConst(0, 1, buf2, symbase, false));
EXPECT_ANY_THROW(val
->getStringConst(0, 1, buf8)[0]);
EXPECT_ANY_THROW(val
...
EXPECT_EQ(val
->getBoolConst(0, 1, buf)[0], '\x80');
EXPECT_EQ(val
->getCharConst(0, 1, buf)[0], '\x80');
// EXPECT_EQ(val->getShortConst(0,1,buf1)[0], SHRT_MIN);
EXPECT_EQ(val
->getIntConst(0, 1, buf2)[0], INT_MIN);
EXPECT_EQ(val
->getLongConst(0, 1, buf3)[0], LLONG_MIN);
EXPECT_EQ(val
->getIndexConst(0, 1, buf4)[0], INDEX_MIN);
EXPECT_EQ(val
->getFloatConst(0, 1, buf5)[0], FLT_NMIN);
EXPECT_EQ(val
->getDoubleConst(0, 1, buf6)[0], DBL_NMIN);
...
EXPECT_EQ(intval
->getBoolBuffer(0, 1, buf)[0], '\xA0');
EXPECT_EQ(intval
->getCharBuffer(0, 1, buf)[0], '\xA0');
// EXPECT_EQ(intval->getShortBuffer(0,1,buf1)[0], SHRT_MIN);
cout << intval->getIntBuffer(0, 1, buf2) <<
endl;
    EXPECT_EQ(buf2[0], 100000);
EXPECT_EQ(intval
->getLongBuffer(0, 1, buf3)[0], 100000);
EXPECT_EQ(intval
->getIndexBuffer(0, 1, buf4)[0], 100000);
EXPECT_EQ(intval
->getFloatBuffer(0, 1, buf5)[0], 100000);
EXPECT_EQ(intval
->getDoubleBuffer(0, 1, buf6)[0], 100000);
...
->getBoolConst(0, 1, buf)[0], 1);
EXPECT_EQ(val
->getCharConst(0, 1, buf)[0], rand_val);
EXPECT_EQ(val
->getShortConst(0, 1, buf1)[0], (short) rand_val);
EXPECT_EQ(val
->getIntConst(0, 1, buf2)[0], (int) rand_val);
EXPECT_EQ(val
->getLongConst(0, 1, buf3)[0], (long long) rand_val);
EXPECT_EQ(val
->getIndexConst(0, 1, buf4)[0], (INDEX) rand_val);
EXPECT_EQ(val
->getFloatConst(0, 1, buf5)[0], (float) rand_val);
EXPECT_EQ(val
->getDoubleConst(0, 1, buf6)[0], (double) rand_val);
EXPECT_ANY_THROW(val
->getSymbolConst(0, 1, buf2, symbase, false));
EXPECT_ANY_THROW(val
->getStringConst(0, 1, buf8)[0]);
...
EXPECT_EQ(charval
->getBoolBuffer(0, 1, buf)[0], rand_val);
EXPECT_EQ(charval
->getCharBuffer(0, 1, buf)[0], rand_val);
EXPECT_EQ(charval
->getShortBuffer(0, 1, buf1)[0], (short) rand_val);
cout << charval->getIntBuffer(0, 1, buf2) <<
endl;
EXPECT_EQ(buf2[0],
(int) rand_val);
EXPECT_EQ(charval
->getLongBuffer(0, 1, buf3)[0], (long) rand_val);
EXPECT_EQ(charval
->getIndexBuffer(0, 1, buf4)[0], (INDEX) rand_val);
EXPECT_EQ(charval
->getFloatBuffer(0, 1, buf5)[0], (float) rand_val);
EXPECT_EQ(charval
->getDoubleBuffer(0, 1, buf6)[0], (double) rand_val);
...
getAllocatedMemory();
            ...
            EXPECT_EQ(val
->getShortConst(0, 1, buf1)[0], (short) rand_val2);
EXPECT_EQ(val
->getIntConst(0, 1, buf2)[0], (int) rand_val2);
EXPECT_EQ(val
->getLongConst(0, 1, buf3)[0], (long long) rand_val2);
EXPECT_EQ(val
->getIndexConst(0, 1, buf4)[0], (INDEX) rand_val2);
EXPECT_EQ(val
->getFloatConst(0, 1, buf5)[0], (float) rand_val2);
EXPECT_EQ(val
->getDoubleConst(0, 1, buf6)[0], (double) rand_val2);
EXPECT_ANY_THROW(val
->getSymbolConst(0, 1, buf2, symbase, false));
EXPECT_ANY_THROW(val
->getStringConst(0, 1, buf8)[0]);
...
EXPECT_EQ(shortval
->getShortBuffer(0, 1, buf1)[0], (short) rand_val2);
cout << shortval->getIntBuffer(0, 1, buf2) <<
endl;
EXPECT_EQ(buf2[0],
(int) rand_val2);
EXPECT_EQ(shortval
->getLongBuffer(0, 1, buf3)[0], (long) rand_val2);
EXPECT_EQ(shortval
->getIndexBuffer(0, 1, buf4)[0], (INDEX) rand_val2);
EXPECT_EQ(shortval
->getFloatBuffer(0, 1, buf5)[0], (float) rand_val2);
EXPECT_EQ(shortval
->getDoubleBuffer(0, 1, buf6)[0], (double) rand_val2);
...
getAllocatedMemory();
            ...
            EXPECT_EQ(val
->getIntConst(0, 1, buf2)[0], (int) rand_val3);
EXPECT_EQ(val
->getLongConst(0, 1, buf3)[0], (long long) rand_val3);
EXPECT_EQ(val
->getIndexConst(0, 1, buf4)[0], (INDEX) rand_val3);
EXPECT_EQ(val
->getFloatConst(0, 1, buf5)[0], (float) rand_val3);
EXPECT_EQ(val
->getDoubleConst(0, 1, buf6)[0], (double) rand_val3);
EXPECT_ANY_THROW(val
->getSymbolConst(0, 1, buf2, symbase, false));
EXPECT_ANY_THROW(val
->getStringConst(0, 1, buf8)[0]);
...
cout << longval->getIntBuffer(0, 1, buf2) <<
endl;
EXPECT_EQ(buf2[0],
(int) rand_val3);
EXPECT_EQ(longval
->getLongBuffer(0, 1, buf3)[0], (long long) rand_val3);
EXPECT_EQ(longval
->getIndexBuffer(0, 1, buf4)[0], (INDEX) rand_val3);
EXPECT_EQ(longval
->getFloatBuffer(0, 1, buf5)[0], (float) rand_val3);
EXPECT_EQ(longval
->getDoubleBuffer(0, 1, buf6)[0], (double) rand_val3);
...
->getHash(0, 1, buckets, buf2));
EXPECT_TRUE(val
->getBoolConst(0, 1, buf));
EXPECT_TRUE(val
->getCharConst(0, 1, buf));
EXPECT_TRUE(val
->getShortConst(0, 1, buf1));
EXPECT_TRUE(val
->getIntConst(0, 1, buf2));
EXPECT_TRUE(val
->getLongConst(0, 1, buf3));
EXPECT_TRUE(val
->getIndexConst(0, 1, buf4));
EXPECT_TRUE(val
->getFloatConst(0, 1, buf5));
EXPECT_TRUE(val
->getDoubleConst(0, 1, buf6));
EXPECT_ANY_THROW(val
->getSymbolConst(0, 1, buf2, symbase, false)[0]);
EXPECT_ANY_THROW(val
->getStringConst(0, 1, buf8)[0]);
EXPECT_ANY_THROW(val
->getStringConst(0, 1, buf9)[0]);
EXPECT_ANY_THROW(val
->getBinaryConst(0, 1, 1, buf10)[0]);
    }

// EXPECT_EQ(longval->getBoolBuffer(0,1,buf)[0], 1);
// EXPECT_EQ(longval->getCharBuffer(0,1,buf)[0], rand_val4);
EXPECT_EQ(floatval
->getShortBuffer(0, 1, buf1)[0], (short) 2);
cout << floatval->getIntBuffer(0, 1, buf2) <<
endl;
EXPECT_EQ(buf2[0],
(int) 2);
EXPECT_EQ(floatval
->getLongBuffer(0, 1, buf3)[0], (long long) 2);
EXPECT_EQ(floatval
->getIndexBuffer(0, 1, buf4)[0], (INDEX) 1);
EXPECT_EQ(floatval
->getFloatBuffer(0, 1, buf5)[0], (float) rand_val4);
EXPECT_EQ(floatval
->getDoubleBuffer(0, 1, buf6)[0], (double) rand_val4);
...
EXPECT_EQ(doubleval
->getShortBuffer(0, 1, buf1)[0], (short) 2);
cout << doubleval->getIntBuffer(0, 1, buf2) <<
endl;
EXPECT_EQ(buf2[0],
(int) 2);
EXPECT_EQ(doubleval
->getLongBuffer(0, 1, buf3)[0], (long long) 2);
EXPECT_EQ(doubleval
->getIndexBuffer(0, 1, buf4)[0], (INDEX) 2);
EXPECT_EQ(doubleval
->getFloatBuffer(0, 1, buf5)[0], (float) rand_val5);
EXPECT_EQ(doubleval
->getDoubleBuffer(0, 1, buf6)[0], (double) rand_val5);
...
EXPECT_EQ(datetimeval
->
castTemporal(DT_DATE)
->
...
EXPECT_EQ(datetimeval
->
castTemporal(DT_MINUTE)
->

getString(), conn

.run("minute(datetime(1))")->
...
EXPECT_EQ(datetimeval
->
castTemporal(DT_SECOND)
->

getString(), conn

.run("second(datetime(1))")->
...
EXPECT_EQ(datetimeval
->
castTemporal(DT_DATETIME)
->

getString(), conn

.run("datetime(datetime(1))")->
...
EXPECT_EQ(datetimeval
->
castTemporal(DT_TIMESTAMP)
->

getString(), conn

.run("timestamp(datetime(1))")->
...
EXPECT_EQ(datetimeval
->
castTemporal(DT_NANOTIME)
->

getString(), conn

.run("nanotime(datetime(1))")->
...
EXPECT_EQ(datetimeval
->
castTemporal(DT_NANOTIMESTAMP)
->

getString(), conn

.run("nanotimestamp(datetime(1))")->
...
EXPECT_EQ(datetimeval
->
castTemporal(DT_DATEHOUR)
->

getString(), conn

.run("datehour(datetime(1))")->
...
EXPECT_EQ(Util::createDateTime(INT_MIN)
->
castTemporal(DT_DATE)
->
...
EXPECT_EQ(Util::createDateTime(negSec)
->
castTemporal(DT_DATEHOUR)
->
...
EXPECT_EQ(Util::createDateTime(negSec3600)
->
castTemporal(DT_DATEHOUR)
->
...
.run("datehour(datetime(" +
to_string(negSec3600)
+ "))")->

getString()

);
EXPECT_EQ(Util::createDateTime(posSec)
->
castTemporal(DT_DATEHOUR)
->
...
EXPECT_EQ(Util::createDateTime(posSec3600)
->
castTemporal(DT_DATEHOUR)
->
...
EXPECT_EQ(Util::createDateTime(negSec86400)
->
castTemporal(DT_DATE)
->
...
EXPECT_EQ(Util::createDateTime(posSec86400)
->
castTemporal(DT_DATE)
->
...
.run("date(nanotimestamp(1000000))")->
...
.run("month(nanotimestamp(1000000))")->
...
.run("time(nanotimestamp(1000000))")->
...
.run("minute(nanotimestamp(1000000))")->
...
.run("second(nanotimestamp(1000000))")->
...
.run("datetime(nanotimestamp(1000000))")->
...
.run("timestamp(nanotimestamp(1000000))")->
...
.run("nanotime(nanotimestamp(1000000))")->
...
.run("nanotimestamp(nanotimestamp(1000000))")->
...
.run("datehour(nanotimestamp(1000000))")->
...
posSec = posSec % 3600000000000 == 0 ? posSec + 1 : posSec;
    ...
    // cout<<negSec<<endl<<posSec<<endl<<negSec3600<<endl<<posSec3600<<endl;
    EXPECT_EQ(Util::createNanoTimestamp(LLONG_MIN)
->
castTemporal(DT_NANOTIMESTAMP)
->
...
.run("nanotimestamp(nanotimestamp(" +
to_string(LLONG_MIN)
+ "))")->
...
EXPECT_EQ(Util::createNanoTimestamp(negSec)
->
castTemporal(DT_DATEHOUR)
->
...
EXPECT_EQ(Util::createNanoTimestamp(negSec3600)
->
castTemporal(DT_DATEHOUR)
->
...
EXPECT_EQ(Util::createNanoTimestamp(posSec)
->
castTemporal(DT_DATEHOUR)
->
...
EXPECT_EQ(Util::createNanoTimestamp(posSec3600)
->
castTemporal(DT_DATEHOUR)
->
...
EXPECT_EQ(Util::createNanoTimestamp(negSec86400)
->
castTemporal(DT_DATE)
->
...
EXPECT_EQ(Util::createNanoTimestamp(posSec86400)
->
castTemporal(DT_DATE)
->
...
.run("datetime(timestamp(1000000))")->
...
.run("timestamp(timestamp(1000000))")->
...
.run("nanotime(timestamp(1000000))")->
...
.run("nanotimestamp(timestamp(1000000))")->
...
.run("datehour(timestamp(1000000))")->
...
posSec = posSec % 3600 == 0 ? posSec + 1 : posSec;
    ...
    // cout<<negSec<<endl<<posSec<<endl<<negSec3600<<endl<<posSec3600<<endl;
    EXPECT_EQ(Util::createTimestamp(LLONG_MIN)
->
castTemporal(DT_NANOTIMESTAMP)
->
...
EXPECT_EQ(Util::createTimestamp(negSec)
->
castTemporal(DT_DATEHOUR)
->
...
EXPECT_EQ(Util::createTimestamp(negSec3600)
->
castTemporal(DT_DATEHOUR)
->
...
EXPECT_EQ(Util::createTimestamp(posSec)
->
castTemporal(DT_DATEHOUR)
->
...
EXPECT_EQ(Util::createTimestamp(posSec3600)
->
castTemporal(DT_DATEHOUR)
->
...
EXPECT_EQ(Util::createTimestamp(negSec86400)
->
castTemporal(DT_DATE)
->
...
EXPECT_EQ(Util::createTimestamp(posSec86400)
->
castTemporal(DT_DATE)
->
...
getString()
    ...
    // cout<<negSec<<endl<<posSec<<endl<<negSec3600<<endl<<posSec3600<<endl;
    EXPECT_EQ(Util::createDateHour(INT_MIN)
->
castTemporal(DT_NANOTIMESTAMP)
->
...
getString()
    ...
    // cout<<negSec<<endl<<posSec<<endl<<negSec3600<<endl<<posSec3600<<endl;
    EXPECT_EQ(Util::createDate(INT_MIN)
->
castTemporal(DT_NANOTIMESTAMP)
->
...
.run("nanotime(second(1))")->

getString()

);
    EXPECT_ANY_THROW(secondval->castTemporal(DT_NANOTIMESTAMP));
EXPECT_ANY_THROW(secondval
->
castTemporal(DT_DATEHOUR)
);

    // cout<<negSec<<endl<<posSec<<endl<<negSec3600<<endl<<posSec3600<<endl;
    EXPECT_EQ(Util::createSecond(INT_MIN)
->
castTemporal(DT_TIME)
->
...
.run("nanotime(minute(1))")->

getString()

);
    EXPECT_ANY_THROW(minuteval->castTemporal(DT_NANOTIMESTAMP));
EXPECT_ANY_THROW(minuteval
->
castTemporal(DT_DATEHOUR)
);

    // cout<<negSec<<endl<<posSec<<endl<<negSec3600<<endl<<posSec3600<<endl;
    EXPECT_EQ(Util::createMinute(INT_MIN)
->
castTemporal(DT_TIME)
->
...
getString()
    ...
    // cout<<negSec<<endl<<posSec<<endl<<negSec3600<<endl<<posSec3600<<endl;
    EXPECT_EQ(Util::createTime(INT_MIN)
->
castTemporal(DT_TIME)
->
...
getString()
    ...
    // cout<<negSec<<endl<<posSec<<endl<<negSec3600<<endl<<posSec3600<<endl;
    EXPECT_EQ(Util::createNanoTime(LLONG_MIN)
->
castTemporal(DT_TIME)
->
...
i++)
        ...
        EXPECT_EQ(Util::parseConstant(DT_CHAR, charactors[i])
->
