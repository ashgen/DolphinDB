...
v1});
EXPECT_EQ(v1
->getInstance()->getString(), "set()");
EXPECT_EQ(v1
->getValue()->getString(), "set(\"中文*……%#￥#！a\",\"123abc\")");
...
v1->
remove(Util::createString("中文*……%#￥#！a")
);
EXPECT_EQ(v1
->getValue()->getString(), "set(\"123abc\")");
...
v1->
contain(Util::createString("123abc"), res
);
EXPECT_TRUE(res
->
...
EXPECT_EQ(v2
->
interaction(Util::createString("123abc")
)->
...
EXPECT_EQ(v2
->
interaction(Util::createString("中文*……%#￥#！a")
)->
...
EXPECT_EQ(v2
->
interaction(Util::createString("444")
)->
...
true);
EXPECT_EQ(v1
->keys()->getString(), res_v->keys()->getString());
}
...
);// symbol set doesn't supported yet
}
...
v1->
remove(Util::createChar(0)
);
EXPECT_EQ(v1
->getValue()->getString(), "set(1)");
ConstantSP res = Util::createConstant(DT_BOOL);
ConstantSP res1 = Util::createConstant(DT_BOOL);
res->
...
EXPECT_FALSE(v1
->
inverse(Util::createChar(2)
));
SetSP temp = Util::createSet(DT_NANOTIME, 1);
SetSP temp1 = Util::createSet(DT_CHAR, 1);
temp1->
append(Util::createChar(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
EXPECT_FALSE(v1
->
inverse(Util::createInt(2)
));
SetSP temp = Util::createSet(DT_NANOTIME, 1);
SetSP temp1 = Util::createSet(DT_INT, 1);
temp1->
append(Util::createInt(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
EXPECT_FALSE(v1
->
inverse(Util::createLong(2)
));
SetSP temp = Util::createSet(DT_NANOTIME, 1);
SetSP temp1 = Util::createSet(DT_LONG, 1);
temp1->
append(Util::createLong(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
v1->
contain(Util::createShort(1), res
);
EXPECT_TRUE(res
->
...
EXPECT_FALSE(v1
->
inverse(Util::createShort(2)
));
SetSP temp = Util::createSet(DT_NANOTIME, 1);
SetSP temp1 = Util::createSet(DT_SHORT, 1);
temp1->
append(Util::createShort(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
EXPECT_EQ(v2
->
interaction(Util::createShort(1)
)->
...
EXPECT_EQ(v2
->
interaction(Util::createShort(0)
)->
...
EXPECT_EQ(v2
->
interaction(Util::createShort(2)
)->
...
v1->
contain(Util::createFloat(1), res
);
EXPECT_TRUE(res
->
...
EXPECT_FALSE(v1
->
inverse(Util::createFloat(2)
));
SetSP temp = Util::createSet(DT_NANOTIME, 1);
SetSP temp1 = Util::createSet(DT_FLOAT, 1);
temp1->
append(Util::createFloat(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
EXPECT_EQ(v2
->
interaction(Util::createFloat(1)
)->
...
EXPECT_EQ(v2
->
interaction(Util::createFloat(0)
)->
...
EXPECT_EQ(v2
->
interaction(Util::createFloat(2)
)->
...
v1->
contain(Util::createDouble(1), res
);
EXPECT_TRUE(res
->
...
EXPECT_FALSE(v1
->
inverse(Util::createDouble(2)
));
SetSP temp = Util::createSet(DT_NANOTIME, 1);
SetSP temp1 = Util::createSet(DT_DOUBLE, 1);
temp1->
append(Util::createDouble(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
EXPECT_EQ(v2
->
interaction(Util::createDouble(1)
)->
...
EXPECT_EQ(v2
->
interaction(Util::createDouble(0)
)->
...
EXPECT_EQ(v2
->
interaction(Util::createDouble(2)
)->
...
->getInstance()->getString(), "set()");
EXPECT_EQ(v1
->getValue()->getString(), "set(1981.05.29T16,1970.01.01T01)");
...
v1->
remove(Util::createDateHour(1)
);
EXPECT_EQ(v1
->getValue()->getString(), "set(1981.05.29T16)");
ConstantSP res = Util::createConstant(DT_BOOL);
ConstantSP res1 = Util::createConstant(DT_BOOL);
res->
...
v1->
contain(Util::createDateHour(100000), res
);
EXPECT_TRUE(res
->
...
EXPECT_EQ(v2
->
interaction(Util::createDateHour(100000)
)->
...
EXPECT_EQ(v2
->
interaction(Util::createDateHour(1)
)->
...
EXPECT_EQ(v2
->
interaction(Util::createDateHour(2)
)->
...
->getInstance()->getString(), "set()");
EXPECT_EQ(v1
->getValue()->getString(), "set(2103.06.23,1970.01.02)");
...
v1->
remove(Util::createDate(1)
);
EXPECT_EQ(v1
->getValue()->getString(), "set(2103.06.23)");
ConstantSP res = Util::createConstant(DT_BOOL);
ConstantSP res1 = Util::createConstant(DT_BOOL);
res->
...
v1->
contain(Util::createDate(48750), res
);
EXPECT_TRUE(res
->
...
EXPECT_FALSE(v1
->
inverse(Util::createDate(2)
));
SetSP temp = Util::createSet(DT_STRING, 1);
SetSP temp1 = Util::createSet(DT_DATE, 1);
temp1->
append(Util::createDate(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
EXPECT_EQ(v2
->
interaction(Util::createDate(48750)
)->
...
->getInstance()->getString(), "set()");
EXPECT_EQ(v1
->getValue()->getString(), "set(16:40m,00:01m)");
...
v1->
remove(Util::createMinute(1)
);
EXPECT_EQ(v1
->getValue()->getString(), "set(16:40m)");
ConstantSP res = Util::createConstant(DT_BOOL);
ConstantSP res1 = Util::createConstant(DT_BOOL);
res->
...
v1->
contain(Util::createMinute(1000), res
);
EXPECT_TRUE(res
->
...
EXPECT_FALSE(v1
->
inverse(Util::createMinute(2)
));

EXPECT_FALSE(v1
->
inverse(Util::createString("2")
));
v1->
inverse(v1);
EXPECT_EQ(v1
...
EXPECT_EQ(v2
->
interaction(Util::createMinute(1000)
)->
...
EXPECT_EQ(v2
->
interaction(Util::createMinute(1)
)->
...
EXPECT_EQ(v2
->
interaction(Util::createMinute(2)
)->
...
->getInstance()->getString(), "set()");
EXPECT_EQ(v1
->getValue()->getString(), "set(1970.01.01T13:32:30,1970.01.01T00:00:01)");
...
v1->
remove(Util::createDateTime(1)
);
EXPECT_EQ(v1
->getValue()->getString(), "set(1970.01.01T13:32:30)");
ConstantSP res = Util::createConstant(DT_BOOL);
ConstantSP res1 = Util::createConstant(DT_BOOL);
res->
...
v1->
contain(Util::createDateTime(48750), res
);
EXPECT_TRUE(res
->
...
EXPECT_FALSE(v1
->
inverse(Util::createDateTime(2)
));
SetSP temp = Util::createSet(DT_STRING, 1);
SetSP temp1 = Util::createSet(DT_DATETIME, 1);
temp1->
append(Util::createDateTime(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
EXPECT_EQ(v2
->
interaction(Util::createDateTime(48750)
)->

getString(),

"set(1970.01.01T13:32:30)");
EXPECT_EQ(v2
->
interaction(Util::createDateTime(1)
)->

getString(),

"set(1970.01.01T00:00:01)");
EXPECT_EQ(v2
->
interaction(Util::createDateTime(2)
)->
...
->getInstance()->getString(), "set()");
EXPECT_EQ(v1
->getValue()->getString(), "set(2001.09.09T01:46:40.000,1970.01.01T00:00:00.001)");
...
v1->
remove(Util::createTimestamp(1)
);
EXPECT_EQ(v1
->getValue()->getString(), "set(2001.09.09T01:46:40.000)");
ConstantSP res = Util::createConstant(DT_BOOL);
ConstantSP res1 = Util::createConstant(DT_BOOL);
res->
...
v1->
contain(Util::createTimestamp(1000000000000), res
);
EXPECT_TRUE(res
->
...
EXPECT_FALSE(v1
->
inverse(Util::createTimestamp(2)
));
SetSP temp = Util::createSet(DT_STRING, 1);
SetSP temp1 = Util::createSet(DT_TIMESTAMP, 1);
temp1->
append(Util::createTimestamp(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
EXPECT_EQ(v2
->
interaction(Util::createTimestamp(1)
)->

getString(),

"set(1970.01.01T00:00:00.001)");
EXPECT_EQ(v2
->
interaction(Util::createTimestamp(1000000000000)
)->

getString(),

"set(2001.09.09T01:46:40.000)");
EXPECT_EQ(v2
->
interaction(Util::createTimestamp(2)
)->
...
->getInstance()->getString(), "set()");
EXPECT_EQ(v1
->getValue()->getString(), "set(00:16:40.000000000,00:00:00.000000001)");
...
v1->
remove(Util::createNanoTime(1)
);
EXPECT_EQ(v1
->getValue()->getString(), "set(00:16:40.000000000)");
ConstantSP res = Util::createConstant(DT_BOOL);
ConstantSP res1 = Util::createConstant(DT_BOOL);
res->
...
v1->
contain(Util::createNanoTime(1000000000000), res
);
EXPECT_TRUE(res
->
...
EXPECT_FALSE(v1
->
inverse(Util::createNanoTime(2)
));
SetSP temp = Util::createSet(DT_STRING, 1);
SetSP temp1 = Util::createSet(DT_NANOTIME, 1);
temp1->
append(Util::createNanoTime(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
EXPECT_EQ(v2
->
interaction(Util::createNanoTime(1000000000000)
)->

getString(),

"set(00:16:40.000000000)");
EXPECT_EQ(v2
->
interaction(Util::createNanoTime(1)
)->

getString(),

"set(00:00:00.000000001)");
EXPECT_EQ(v2
->
interaction(Util::createNanoTime(2)
)->
...
->getInstance()->getString(), "set()");
EXPECT_EQ(v1
->getValue()->getString(), "set(1970.01.01T00:16:40.000000000,1970.01.01T00:00:00.000000001)");
...
v1->
remove(Util::createNanoTimestamp(1)
);
EXPECT_EQ(v1
->getValue()->getString(), "set(1970.01.01T00:16:40.000000000)");
ConstantSP res = Util::createConstant(DT_BOOL);
ConstantSP res1 = Util::createConstant(DT_BOOL);
res->
...
v1->
contain(Util::createNanoTimestamp(1000000000000), res
);
EXPECT_TRUE(res
->
...
EXPECT_FALSE(v1
->
inverse(Util::createNanoTimestamp(2)
));
SetSP temp = Util::createSet(DT_STRING, 1);
SetSP temp1 = Util::createSet(DT_NANOTIMESTAMP, 1);
temp1->
append(Util::createNanoTimestamp(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
EXPECT_EQ(v2
->
interaction(Util::createNanoTimestamp(1000000000000)
)->

getString(),

"set(1970.01.01T00:16:40.000000000)");
EXPECT_EQ(v2
->
interaction(Util::createNanoTimestamp(1)
)->

getString(),

"set(1970.01.01T00:00:00.000000001)");
EXPECT_EQ(v2
->
interaction(Util::createNanoTimestamp(2)
)->
...
->getInstance()->getString(), "set()");
EXPECT_EQ(v1
->getValue()->getString(), "set(0083.05M,0000.02M)");
...
v1->
remove(Util::createMonth(1)
);
EXPECT_EQ(v1
->getValue()->getString(), "set(0083.05M)");
ConstantSP res = Util::createConstant(DT_BOOL);
ConstantSP res1 = Util::createConstant(DT_BOOL);
res->
...
v1->
contain(Util::createMonth(1000), res
);
EXPECT_TRUE(res
->
...
EXPECT_FALSE(v1
->
inverse(Util::createMonth(2)
));
SetSP temp = Util::createSet(DT_STRING, 1);
SetSP temp1 = Util::createSet(DT_MONTH, 1);
temp1->
append(Util::createMonth(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
EXPECT_EQ(v2
->
interaction(Util::createMonth(1)
)->
...
EXPECT_EQ(v2
->
interaction(Util::createMonth(1000)
)->
...
EXPECT_EQ(v2
->
interaction(Util::createMonth(2)
)->
...
v1->
append(Util::createTime((long) 10000000)
);
...
->getInstance()->getString(), "set()");
EXPECT_EQ(v1
->getValue()->getString(), "set(02:46:40.000,00:00:00.001)");
...
v1->
remove(Util::createTime(1)
);
EXPECT_EQ(v1
->getValue()->getString(), "set(02:46:40.000)");
ConstantSP res = Util::createConstant(DT_BOOL);
ConstantSP res1 = Util::createConstant(DT_BOOL);
res->
...
v1->
contain(Util::createTime(10000000), res
);
EXPECT_TRUE(res
->
...
EXPECT_FALSE(v1
->
inverse(Util::createTime(2)
));
SetSP temp = Util::createSet(DT_STRING, 1);
SetSP temp1 = Util::createSet(DT_TIME, 1);
temp1->
append(Util::createTime(9)
);
EXPECT_FALSE(v1
->
inverse(temp)
...
EXPECT_EQ(v2
->
interaction(Util::createTime(10000000)
)->
...
->getInstance()->getString(), "set()");
EXPECT_EQ(v1
->getValue()->getString(), "set(00000000000000000000000000000000,e1671797c52e15f763380b45e841ec32)");
...
remove (Util::createNullConstant(DT_INT128));

EXPECT_EQ(v1
->getValue()->getString(), "set(e1671797c52e15f763380b45e841ec32)");
ConstantSP res = Util::createConstant(DT_BOOL);
ConstantSP res1 = Util::createConstant(DT_BOOL);
res->
...
inverse (Util::createNullConstant(DT_INT128))
...
EXPECT_EQ(v2
->
interaction(int128val)
->

getString(),

"set(e1671797c52e15f763380b45e841ec32)");
EXPECT_EQ(v2
->

interaction (Util::createNullConstant(DT_INT128))

->

getString(),

"set(00000000000000000000000000000000)");
EXPECT_EQ(v2
->
interaction(Util::parseConstant(DT_INT128, "e1671797c52e15f763380b45e841ec33")
)->
...
->getInstance()->getString(), "set()");
EXPECT_EQ(v1
->getValue()->getString(), "set(0.0.0.0,192.168.1.13)");
...
remove (Util::createNullConstant(DT_IP));

EXPECT_EQ(v1
->getValue()->getString(), "set(192.168.1.13)");
ConstantSP res = Util::createConstant(DT_BOOL);
ConstantSP res1 = Util::createConstant(DT_BOOL);
res->
...
inverse (Util::createNullConstant(DT_IP))
...
interaction (Util::createNullConstant(DT_IP))
...
EXPECT_EQ(v2
->
interaction(Util::parseConstant(DT_IP, "192.168.1.14")
)->
...
i < 70000; i++)
v1->
append(Util::createNanoTimestamp(i)
);
...
append (Util::createString(to_string(i)));
