...
v1 = Util::createMatrix(DT_STRING, 2, 2, 4)
);
}
...
EXPECT_ANY_THROW(VectorSP
v1 = Util::createMatrix(DT_ANY, 2, 2, 4)
);
}
...
EXPECT_ANY_THROW(VectorSP
v1 = Util::createMatrix(DT_DECIMAL32, 2, 2, 4)
);
}
...
EXPECT_ANY_THROW(VectorSP
v1 = Util::createMatrix(DT_DECIMAL64, 2, 2, 4)
);
}
...
EXPECT_EQ(v1
->getString(1), "{" + v1->getColumn(1)->get(0)->

getString()

+ "," + v1->getColumn(1)->get(1)->
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createBool(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createBool(1)
));
v1->
set(Util::createInt(1), Util::createBool(1)
);
...
"[" + v1->getColumn(0)->get(0)->

getString()

+ "," + v1->getColumn(0)->get(1)->
...
EXPECT_EQ(winMatrix1
->getValue(2)->

getString(),

"[" + winMatrix1->getRow(0)->get(0)->

getString()

+ "," + winMatrix1->getRow(0)->get(1)->
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createChar(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createChar(1)
));
v1->
set(Util::createInt(1), Util::createChar(1)
);
...
VectorSP v1 = Util::createMatrix(DT_CHAR, 2, 2, 4);
v1->set(0, 0,
Util::createNullConstant(DT_CHAR)
);
v1->set(1, 0,
Util::createNullConstant(DT_CHAR)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createInt(1)
));
EXPECT_ANY_THROW(v1
->
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createLong(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createLong(1)
));
v1->
set(Util::createInt(1), Util::createLong(1)
);
...
v1->set(0, 0,
Util::createNullConstant(DT_SHORT)
);
v1->set(1, 0,
Util::createNullConstant(DT_SHORT)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createShort(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createShort(1)
));
v1->
set(Util::createInt(1), Util::createShort(1)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createFloat(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createFloat(1)
));
v1->
set(Util::createInt(1), Util::createFloat(1)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createDouble(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createDouble(1)
));
v1->
set(Util::createInt(1), Util::createDouble(1)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createDateHour(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createDateHour(1)
));
v1->
set(Util::createInt(1), Util::createDateHour(1)
);
...
VectorSP v1 = Util::createMatrix(DT_DATEHOUR, 2, 2, 4);
v1->set(0, 0,
Util::createNullConstant(DT_DATEHOUR)
);
v1->set(1, 0,
Util::createNullConstant(DT_DATEHOUR)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createDate(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createDate(1)
));
v1->
set(Util::createInt(1), Util::createDate(1)
);
...
VectorSP v1 = Util::createMatrix(DT_DATE, 2, 2, 4);
v1->set(0, 0,
Util::createNullConstant(DT_DATE)
);
v1->set(1, 0,
Util::createNullConstant(DT_DATE)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createMinute(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createMinute(1)
));
v1->
set(Util::createInt(1), Util::createMinute(1)
);
...
VectorSP v1 = Util::createMatrix(DT_MINUTE, 2, 2, 4);
v1->set(0, 0,
Util::createNullConstant(DT_MINUTE)
);
v1->set(1, 0,
Util::createNullConstant(DT_MINUTE)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createSecond(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createSecond(1)
));
v1->
set(Util::createInt(1), Util::createSecond(1)
);
...
VectorSP v1 = Util::createMatrix(DT_SECOND, 2, 2, 4);
v1->set(0, 0,
Util::createNullConstant(DT_SECOND)
);
v1->set(1, 0,
Util::createNullConstant(DT_SECOND)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createDateTime(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createDateTime(1)
));
v1->
set(Util::createInt(1), Util::createDateTime(1)
);
...
VectorSP v1 = Util::createMatrix(DT_DATETIME, 2, 2, 4);
v1->set(0, 0,
Util::createNullConstant(DT_DATETIME)
);
v1->set(1, 0,
Util::createNullConstant(DT_DATETIME)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createTimestamp(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createTimestamp(1)
));
v1->
set(Util::createInt(1), Util::createTimestamp(1)
);
...
VectorSP v1 = Util::createMatrix(DT_TIMESTAMP, 2, 2, 4);
v1->set(0, 0,
Util::createNullConstant(DT_TIMESTAMP)
);
v1->set(1, 0,
Util::createNullConstant(DT_TIMESTAMP)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createNanoTime(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createNanoTime(1)
));
v1->
set(Util::createInt(1), Util::createNanoTime(1)
);
...
VectorSP v1 = Util::createMatrix(DT_NANOTIME, 2, 2, 4);
v1->set(0, 0,
Util::createNullConstant(DT_NANOTIME)
);
v1->set(1, 0,
Util::createNullConstant(DT_NANOTIME)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createNanoTimestamp(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createNanoTimestamp(1)
));
v1->
set(Util::createInt(1), Util::createNanoTimestamp(1)
);
...
VectorSP v1 = Util::createMatrix(DT_NANOTIMESTAMP, 2, 2, 4);
v1->set(0, 0,
Util::createNullConstant(DT_NANOTIMESTAMP)
);
v1->set(1, 0,
Util::createNullConstant(DT_NANOTIMESTAMP)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createMonth(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createMonth(1)
));
v1->
set(Util::createInt(1), Util::createMonth(1)
);
...
VectorSP v1 = Util::createMatrix(DT_MONTH, 2, 2, 4);
v1->set(0, 0,
Util::createNullConstant(DT_MONTH)
);
v1->set(1, 0,
Util::createNullConstant(DT_MONTH)
);
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(3), Util::createTime(1)
));
EXPECT_ANY_THROW(v1
->
set(Util::createInt(-1), Util::createTime(1)
));
v1->
set(Util::createInt(1), Util::createTime(1)
);
...
VectorSP v1 = Util::createMatrix(DT_TIME, 2, 2, 4);
v1->set(0, 0,
Util::createNullConstant(DT_TIME)
);
v1->set(1, 0,
Util::createNullConstant(DT_TIME)
);
...
j < 300; j++) {
v1->
set(i, j, Util::createTimestamp(1)
);
}
}
...
j < 300; j++) {
v1->
set(i, j, Util::createNanoTimestamp(1)
);
}
}
