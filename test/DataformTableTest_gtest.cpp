...
j++) {
EXPECT_TRUE(judgeres
->
get(i)
->
get(Util::createString("string")
)->
...
tab2->setName("tab2");
EXPECT_EQ(tab2
->keys()->getString(), "[\"sym\",\"string\"]");
EXPECT_EQ(tab2
->getColumnQualifier(0), tab2->
...
EXPECT_EQ(tab1
->
getMember(Util::createString("sym")
)->
...
EXPECT_ANY_THROW(TableSP
tab4 = Util::createTable(colNames, colsNull)
);
EXPECT_ANY_THROW(TableSP
tab4 = Util::createTable(col3Names, cols)
);
...
EXPECT_ANY_THROW(TableSP
tab4 = Util::createTable(colNames, colsDiffrows)
);
...
EXPECT_ANY_THROW(tab1
->getColumn("sym", errCol));
EXPECT_ANY_THROW(tab1
->
getColumn(errCol, errCol
));
...
EXPECT_EQ(tab1
->getColumnName(1), "modifyedname");
EXPECT_EQ(tab1
->getColumnIndex("errcol"), -1);
EXPECT_EQ(tab1
->getColumnIndex("modifyedname"), 1);

EXPECT_TRUE(tab1
->contain("modifyedname"));
EXPECT_TRUE(tab1
->contain("tab1", "modifyedname"));

EXPECT_EQ(tab1
->getColumnName(0), "col1");
EXPECT_EQ(tab1
->getColumn("tab1", "col1")->
...
EXPECT_EQ(tab1
->getColumn("col1", Util::createInt(0))->
...
EXPECT_EQ(tab1
->getColumn("tab1", "col1", Util::createInt(0))->
...
EXPECT_EQ(tab1
->getColumnLabel()->get(0)->

getString(), tab1

->getColumnName(0));
EXPECT_EQ(tab1
->getColumnLabel()->get(1)->
...
getMember(Util::createString("modifyedname")
)->
...
int i = 0;
i < 121; i++) {
dict_size121->set("col" +
to_string(i), Util::createInt(1)
);
}
...
EXPECT_EQ(tab_121cols
->getString(0).
substr(Util::DISPLAY_WIDTH),
"...");
}
...
i < 5; i++) {
names->
set(i, Util::createString("name_" + std::to_string(i))
);
dates->
set(i, Util::createDate(2010, 1, i + 1)
);
prices->
set(i, Util::createDouble(i * i)
);
}
vector <string> allnames = {"names", "dates", "prices"};
vector <ConstantSP> allcols = {names, dates, prices};
conn.
upload(allnames, allcols
...
dict1->set("col2",
Util::createDecimal32(scale2,
1));
dict1->set("col1",
Util::createDecimal32(scale1,
0));
TableSP tab1 = Util::createTable(dict1.get(), 1);
vector <VectorSP> colVecs;
colVecs.reserve(2);
...
string script =
        "a = table(decimal32(1," + to_string(scale1) + ") as col1,decimal32(0," + to_string(scale2) + ") as col2);a";
TableSP tab_res = conn.run(script);
...
getExtraParamForType(), scale1

);
EXPECT_EQ(tab_res
->getColumn(1)->

getExtraParamForType(), scale2
...
vector <ConstantSP> cols = {Util::createNullConstant(DT_DECIMAL32, scale1),
                            Util::createNullConstant(DT_DECIMAL32, scale2)};
TableSP tab3 = Util::createTable(colNames, cols);
...
string script = "a = table(decimal32(NULL," + to_string(scale1) + ") as col1,decimal32(NULL," + to_string(scale2) +
                ") as col2);a";
TableSP tab_res = conn.run(script);
...
dict1->set("col2",
Util::createDecimal64(scale2,
1));
dict1->set("col1",
Util::createDecimal64(scale1,
0));
TableSP tab1 = Util::createTable(dict1.get(), 1);
vector <VectorSP> colVecs;
colVecs.reserve(2);
...
string script =
        "a = table(decimal64(1," + to_string(scale1) + ") as col1,decimal64(0," + to_string(scale2) + ") as col2);a";
TableSP tab_res = conn.run(script);
...
vector <ConstantSP> cols = {Util::createNullConstant(DT_DECIMAL64, scale1),
                            Util::createNullConstant(DT_DECIMAL64, scale2)};
TableSP tab3 = Util::createTable(colNames, cols);
...
string script = "a = table(decimal64(NULL," + to_string(scale1) + ") as col1,decimal64(NULL," + to_string(scale2) +
                ") as col2);a";
TableSP tab_res = conn.run(script);
...
i < 3; i++)
EXPECT_TRUE(conn
.run("each(eqObj, res.values(), mt.values());")->
get(i)
->
...
columnVecs[4]->
set(i, Util::createLong(rand() % LONG_MAX)
);
columnVecs[5]->
set(i, Util::createDate(rand() % LONG_MAX)
);
columnVecs[6]->
set(i, Util::createMonth(rand() % LONG_MAX)
);
columnVecs[7]->
set(i, Util::createTime(rand() % LONG_MAX)
);
columnVecs[8]->
set(i, Util::createMinute(rand() % 1439)
);
columnVecs[9]->
set(i, Util::createDateTime(rand() % LLONG_MAX)
);
columnVecs[10]->
...
<<
endl;
cout << "without fetchSize,time spend: " << (double) (tm2 - tm1) / (double) 1000 <<
endl;
cout << "with fetchSize,time spend: " << (double) (tm3 - tm2) / (double) 1000 <<
endl;
}
...
EXPECT_EQ(resultSet
.
getDataType(i), DT_SYMBOL
);
else
EXPECT_EQ(resultSet
.
getDataType(i), res_tab
->
getColumnType(i)
);
}
ASSERT_EQ(Util::createChar(resultSet.getChar(colIndex++))
->
...
ASSERT_EQ(Util::createBool(resultSet.getBool(colIndex++))
->
...
ASSERT_EQ(Util::createShort(resultSet.getShort(colIndex++))
->
...
ASSERT_EQ(Util::createInt(resultSet.getInt(colIndex++))
->
...
ASSERT_EQ(Util::createLong(resultSet.getLong(colIndex++))
->
...
ASSERT_EQ(Util::createDate(resultSet.getInt(colIndex++))
->
...
ASSERT_EQ(Util::createMonth(resultSet.getInt(colIndex++))
->
...
ASSERT_EQ(Util::createTime(resultSet.getInt(colIndex++))
->
...
ASSERT_EQ(Util::createMinute(resultSet.getInt(colIndex++))
->
...
ASSERT_EQ(Util::createDateTime(resultSet.getInt(colIndex++))
->
...
ASSERT_EQ(Util::createSecond(resultSet.getInt(colIndex++))
->
...
ASSERT_EQ(Util::createTimestamp(resultSet.getLong(colIndex++))
->
...
ASSERT_EQ(Util::createNanoTime(resultSet.getLong(colIndex++))
->
...
ASSERT_EQ(Util::createNanoTimestamp(resultSet.getLong(colIndex++))
->
...
ASSERT_EQ(Util::createFloat(resultSet.getFloat(colIndex++))
->
...
ASSERT_EQ(Util::createDouble(resultSet.getDouble(colIndex++))
->
...
ASSERT_EQ(Util::createString(resultSet.getString(colIndex++))
->
...
ASSERT_EQ(Util::createDateHour(resultSet.getInt(colIndex++))
->
...
cout << "resultset assert finished" <<
endl;
resultSet.
...
vector <DATA_TYPE> colTypesVec1;
colTypesVec1.
emplace_back(DT_CHAR_ARRAY);
colTypesVec1.
emplace_back(DT_BOOL_ARRAY);
colTypesVec1.
emplace_back(DT_SHORT_ARRAY);
colTypesVec1.
emplace_back(DT_INT_ARRAY);
colTypesVec1.
emplace_back(DT_LONG_ARRAY);
colTypesVec1.
emplace_back(DT_DATE_ARRAY);
colTypesVec1.
emplace_back(DT_MONTH_ARRAY);
colTypesVec1.
emplace_back(DT_TIME_ARRAY);
colTypesVec1.
emplace_back(DT_MINUTE_ARRAY);
colTypesVec1.
emplace_back(DT_DATETIME_ARRAY);
colTypesVec1.
emplace_back(DT_SECOND_ARRAY);
colTypesVec1.
emplace_back(DT_TIMESTAMP_ARRAY);
colTypesVec1.
emplace_back(DT_NANOTIME_ARRAY);
colTypesVec1.
emplace_back(DT_NANOTIMESTAMP_ARRAY);
colTypesVec1.
emplace_back(DT_DATEHOUR_ARRAY);
colTypesVec1.
emplace_back(DT_FLOAT_ARRAY);
colTypesVec1.
emplace_back(DT_DOUBLE_ARRAY);
colTypesVec1.
emplace_back(DT_UUID_ARRAY);
colTypesVec1.
emplace_back(DT_IP_ARRAY);
colTypesVec1.
emplace_back(DT_INT128_ARRAY);
