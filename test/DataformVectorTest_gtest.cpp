...
((VectorSP) v1)->
append(Util::createString("0")
);
((VectorSP) v1)->
append(Util::createString("1")
);
EXPECT_TRUE(v1
->
...
EXPECT_TRUE(symbolVector
->has("0"));
EXPECT_FALSE(symbolVector
->has("2"));
}
...
((VectorSP) v1)->
append(Util::createInt(0)
);
((VectorSP) v1)->
append(Util::createInt(1)
);
EXPECT_TRUE(v1
->
...
DATA_TYPE type;
EXPECT_FALSE(anyVector
->
isHomogeneousScalar(type)
);

anyVector->
append(Util::createVector(DT_INT, 0, 3)
);
EXPECT_FALSE(anyVector
->
isHomogeneousScalar(type)
...
EXPECT_EQ(res
->getString(0), "1970.01.01");
EXPECT_EQ(res
->getString(1), "1970.01.02");
}
...
EXPECT_EQ(res
->getString(0), "1970.01.01T00:00:00");
EXPECT_EQ(res
->getString(1), "1970.01.01T00:00:01");
}
...
EXPECT_EQ(res
->getString(0), "1970.01.01T00");
EXPECT_EQ(res
->getString(1), "1970.01.01T01");
}
...
EXPECT_EQ(res
->getString(0), "0000.01M");
EXPECT_EQ(res
->getString(1), "0000.02M");
}
...
EXPECT_EQ(res
->getString(0), "00:00:00.000");
EXPECT_EQ(res
->getString(1), "00:00:00.001");
}
...
EXPECT_EQ(res
->getString(0), "00:00:00");
EXPECT_EQ(res
->getString(1), "00:00:01");
}
...
EXPECT_EQ(res
->getString(0), "00:00:00.000000000");
EXPECT_EQ(res
->getString(1), "00:00:00.000000001");
}
...
EXPECT_EQ(res
->getString(0), "1970.01.01T00:00:00.000");
EXPECT_EQ(res
->getString(1), "1970.01.01T00:00:00.001");
}
...
EXPECT_EQ(res
->getString(0), "1970.01.01T00:00:00.000000000");
EXPECT_EQ(res
->getString(1), "1970.01.01T00:00:00.000000001");
}
...
);// anyvector is absolutely not null
EXPECT_EQ(v2
->
...
setNull();// nothing to do and anyvector is not changed.
EXPECT_EQ(v4
->
...
EXPECT_ANY_THROW(v2
->
replace(Util::createInt(1), Util::createInt(0)
));
EXPECT_ANY_THROW(v2
->
asof(Util::createInt(1)
));
...
EXPECT_FALSE(v5
->
assign(Util::createVector(DT_INT, 5, 5)
));
v5->
assign(Util::createString("5")
);
EXPECT_EQ(v5
->
...
"(\"5\",\"5\")");
v5->
assign(Util::createNullConstant(DT_INT)
);
EXPECT_EQ(v5
->
...
v5->set(1, Util::createInt(1));
v5->
append(Util::createString("str")
);
v5->

append (Util::createNullConstant(DT_BOOL));

v5->
nullFill(Util::createDateTime(30000)
);
EXPECT_EQ(v5
->
...
"(3.21,1,\"str\",1970.01.01T08:20:00)");
...
"(1971.12.02,1971.12.02,1971.12.02,1970.01.01T08:20:00)");
VectorSP valVec = Util::createVector(DT_IP, 3, 3);
valVec->set(0,
Util::createNullConstant(DT_UUID)
);
valVec->set(1,
Util::parseConstant(DT_IP,
"192.0.0.5"));
valVec->set(2,
Util::parseConstant(DT_IP,
"10.20.30.40"));
...
"(,192.0.0.5,10.20.30.40,1970.01.01T08:20:00)");
...
cout << v5->getAllocatedMemory(1) <<
endl;// AC-122: not supported
...
EXPECT_EQ(v7
->getBoolConst(1, 1, buf4)[0], (bool) 1);
EXPECT_EQ(v7
->getCharConst(1, 1, buf5)[0], (char) 1);
EXPECT_EQ(v7
->getShortConst(1, 1, buf6)[0], (short) 1);
EXPECT_EQ(v7
->getIntConst(1, 1, buf7)[0], (int) 1);
EXPECT_EQ(v7
->getIndexConst(1, 1, buf8)[0], (INDEX) 1);
EXPECT_EQ(v7
->getLongConst(1, 1, buf9)[0], (long) 1);
EXPECT_EQ(v7
->getFloatConst(1, 1, buf10)[0], (float) 1);
EXPECT_EQ(v7
->getDoubleConst(1, 1, buf11)[0], (float) 1);
delete[] buf4, buf5, buf6, buf7, buf8, buf9, buf10,
buf11;

VectorSP indexVec = Util::createIndexVector(0, 3);
INDEX index = 2;
v7->
set(index, Util::createString("setstr")
);
EXPECT_EQ(v7
->get(2)->
...
"setstr");
v7->
set(index, Util::createNullConstant(DT_STRING)
);
EXPECT_TRUE(v7
->get(2)->
...
v7->
set(indexVec, Util::createNullConstant(DT_INT)
);
EXPECT_EQ(v7
->
...
v7->
append(Util::createNullConstant(DT_INT)
);
EXPECT_TRUE(v7
->get(2)->
...
v7->
append(Util::createDecimal32(2, 3.1234)
);
v7->
append(Util::createDecimal64(5, 3.1234)
);
conn.upload("v7", v7);
EXPECT_EQ(conn
.run("typestr(v7[6])")->
...
EXPECT_EQ(v1
->compare(1, Util::createString("中文！@￥#%……a")), 0);
EXPECT_EQ(v1
->
...
getString(), Util::createString("中文！@￥#%……a")
...
getString(), Util::createString("asd123!@#")
...
v1->
set(Util::createInt(1), Util::createInt(1)
);
EXPECT_EQ(v1
->get(1)->
...
"1");
v1->
set(Util::createInt(0), Util::createNullConstant(DT_INT)
);
EXPECT_TRUE(v1
->get(0)->
...
EXPECT_ANY_THROW(v1
->
set(Util::createInt(1), Util::createVector(DT_STRING, 1, 1)
));

EXPECT_FALSE(v1
->
assign(Util::createVector(DT_STRING, 5, 5)
));
v1->
assign(Util::createString("5")
);
...
assign (Util::createNullConstant(DT_STRING));
...
append (Util::createNullConstant(DT_STRING));
...
v2->
nullFill(Util::createString("filled")
);
EXPECT_EQ(v2
->
...
"[\"filled\",\"filled\",\"charstr\",\"filled\"]");

v2->fill(0, 1, Util::createString("twicefilled"));
v2->fill(1, 1,
Util::createNullConstant(DT_STRING)
);
...
EXPECT_EQ(*v2
->getStringConst(0, 1, buf1)[0], v2->get(0)->
...
v2->
replace(Util::createString("3"), Util::createString("replaced")
);
...
"[\"twicefilled\",\"filled\",\"charstr\",\"replaced\"]");
...
EXPECT_ANY_THROW(v1
->fill(2, 1, Util::createString("1")));
v1->fill(2, 1,
Util::createNullConstant(DT_BOOL)
);
EXPECT_TRUE(v1
->
...
1);
v1->
set(indexVec, Util::createNullConstant(DT_BOOL)
);
EXPECT_TRUE(v1
->get(2)->
...
v3->getBool(0, 2, buf9);
EXPECT_EQ((bool) buf9[0], v3->get(0)->

getBool()

);
EXPECT_EQ((bool) buf9[1], v3->get(1)->

getBool()

);
v3->getChar(0, 2, buf9);
EXPECT_EQ((char) buf9[0], v3->get(0)->

getChar()

);
EXPECT_EQ((char) buf9[1], v3->get(1)->

getChar()

);
v3->getShort(0, 2, buf10);
EXPECT_EQ((short) buf10[0], v3->get(0)->

getShort()

);
EXPECT_EQ((short) buf10[1], v3->get(1)->

getShort()

);
v3->getInt(0, 2, buf11);
EXPECT_EQ((int) buf11[0], v3->get(0)->

getInt()

);
EXPECT_EQ((int) buf11[1], v3->get(1)->

getInt()

);
v3->getLong(0, 2, buf13);
EXPECT_EQ((long long) buf13[0], v3->get(0)->

getLong()

);
EXPECT_EQ((long long) buf13[1], v3->get(1)->
...
EXPECT_EQ((float) buf14[0], v3->get(0)->

getFloat()

);
EXPECT_EQ((float) buf14[1], v3->get(1)->

getFloat()

);
v3->getDouble(0, 2, buf15);
EXPECT_EQ((double) buf15[0], v3->get(0)->

getDouble()

);
EXPECT_EQ((double) buf15[1], v3->get(1)->
...
EXPECT_EQ((bool) resbuf[0], v3->get(0)->

getBool()

);
EXPECT_EQ((bool) resbuf[1], v3->get(1)->
...
EXPECT_EQ((char) resbuf1[0], v3->get(0)->

getChar()

);
EXPECT_EQ((char) resbuf1[1], v3->get(1)->
...
EXPECT_EQ((short) resbuf2[0], v3->get(0)->

getShort()

);
EXPECT_EQ((short) resbuf2[1], v3->get(1)->
...
EXPECT_EQ((int) resbuf3[0], v3->get(0)->

getInt()

);
EXPECT_EQ((int) resbuf3[1], v3->get(1)->
...
EXPECT_EQ((long long) resbuf4[0], v3->get(0)->

getLong()

);
EXPECT_EQ((long long) resbuf4[1], v3->get(1)->
...
EXPECT_EQ((float) resbuf6[0], v3->get(0)->

getFloat()

);
EXPECT_EQ((float) resbuf6[1], v3->get(1)->
...
EXPECT_EQ((double) resbuf7[0], v3->get(0)->

getDouble()

);
EXPECT_EQ((double) resbuf7[1], v3->get(1)->

getDouble()

);

delete[] buf, buf1, buf2, buf3, buf4, buf5, buf6, buf7, buf9, buf10, buf11, buf12, buf13, buf14,
buf15;
}
...
getCategory(), INTEGRAL

);

EXPECT_ANY_THROW(v1
->fill(1, 1, Util::createString("1")));
EXPECT_TRUE(v1
->validIndex(1));
EXPECT_TRUE(v1
->validIndex(0, 1, 1));
...
subv1->
append(Util::createChar('a')
);
subv1->
append(Util::createChar('c')
);
subv1->
...
subv1->
set(indexVec, Util::createChar(3)
);
EXPECT_EQ(subv1
->get(0)->
...
(char) 5);
subv1->
set(index, Util::createNullConstant(DT_CHAR)
);
EXPECT_TRUE(subv1
->get(0)->
...
append (Util::createNullConstant(DT_CHAR));

v1->
nullFill(Util::createChar(9)
);
v1->isNull(0, 3, buf);
...
1);
EXPECT_EQ(v1
->getIndexConst(0, 2, buf_2)[0], 1);
EXPECT_EQ(v1
->getIndexBuffer(0, 2, buf_2)[0], 1);
...
EXPECT_FALSE(v1
->compare(0, Util::createInt(1)));

VectorSP indexVec = Util::createIndexVector(0, 1);
ConstantSP index = Util::createInt(0);
subv1->
set(indexVec, Util::createInt(3)
);
EXPECT_EQ(subv1
->get(0)->
...
(int) 5);
subv1->
set(index, Util::createNullConstant(DT_INT)
);
EXPECT_TRUE(subv1
->get(0)->
...
subv1->set(1,
Util::createNullConstant(DT_INT)
);
EXPECT_TRUE(subv1
->get(1)->
...
setNull();// code nothing to do
v3->set(0, Util::createInt(0));
v3->set(1, Util::createInt(1));
v3->
remove(Util::createInt(1000)
);
...
v5->getBool(0, 2, buf9);
EXPECT_EQ((bool) buf9[0], v5->get(0)->

getBool()

);
EXPECT_EQ((bool) buf9[1], v5->get(1)->

getBool()

);
v5->getChar(0, 2, buf9);
EXPECT_EQ((char) buf9[0], v5->get(0)->

getChar()

);
EXPECT_EQ((char) buf9[1], v5->get(1)->

getChar()

);
v5->getShort(0, 2, buf10);
EXPECT_EQ((short) buf10[0], v5->get(0)->

getShort()

);
EXPECT_EQ((short) buf10[1], v5->get(1)->

getShort()

);
v5->getInt(0, 2, buf11);
EXPECT_EQ((int) buf11[0], v5->get(0)->

getInt()

);
EXPECT_EQ((int) buf11[1], v5->get(1)->

getInt()

);
v5->getLong(0, 2, buf13);
EXPECT_EQ((long long) buf13[0], v5->get(0)->

getLong()

);
EXPECT_EQ((long long) buf13[1], v5->get(1)->
...
EXPECT_EQ((float) buf14[0], v5->get(0)->

getFloat()

);
EXPECT_EQ((float) buf14[1], v5->get(1)->

getFloat()

);
v5->getDouble(0, 2, buf15);
EXPECT_EQ((double) buf15[0], v5->get(0)->

getDouble()

);
EXPECT_EQ((double) buf15[1], v5->get(1)->
...
EXPECT_EQ((bool) resbuf[0], v5->get(0)->

getBool()

);
EXPECT_EQ((bool) resbuf[1], v5->get(1)->
...
EXPECT_EQ((char) resbuf1[0], v5->get(0)->

getChar()

);
EXPECT_EQ((char) resbuf1[1], v5->get(1)->
...
EXPECT_EQ((short) resbuf2[0], v5->get(0)->

getShort()

);
EXPECT_EQ((short) resbuf2[1], v5->get(1)->
...
EXPECT_EQ((int) resbuf3[0], v5->get(0)->

getInt()

);
EXPECT_EQ((int) resbuf3[1], v5->get(1)->
...
EXPECT_EQ((long long) resbuf4[0], v5->get(0)->

getLong()

);
EXPECT_EQ((long long) resbuf4[1], v5->get(1)->
...
EXPECT_EQ((float) resbuf6[0], v5->get(0)->

getFloat()

);
EXPECT_EQ((float) resbuf6[1], v5->get(1)->
...
EXPECT_EQ((double) resbuf7[0], v5->get(0)->

getDouble()

);
EXPECT_EQ((double) resbuf7[1], v5->get(1)->
...
->validIndex(0, 1, 1));
EXPECT_FALSE(v1
->validIndex(0, 1, (long long) 0));

VectorSP subv1 = Util::createVector(DT_LONG, 0, 2);
subv1->
append(Util::createLong(1)
);
subv1->
append(Util::createLong(2)
);
EXPECT_EQ(v1
->compare(0, Util::createLong(1)), 0);
EXPECT_EQ(v1
->compare(0, Util::createLong(0)), 1);
EXPECT_EQ(v1
->compare(0, Util::createLong(3)), -1);

VectorSP indexVec = Util::createIndexVector(0, 1);
ConstantSP index = Util::createLong(0);
subv1->
set(indexVec, Util::createLong(3)
);
EXPECT_EQ(subv1
->get(0)->
...
(long long) 5);
subv1->
set(index, Util::createNullConstant(DT_LONG)
);
EXPECT_TRUE(subv1
->get(0)->
...
subv1->set(1,
Util::createNullConstant(DT_LONG)
);
EXPECT_TRUE(subv1
->get(1)->
...
"[-2,-1]");
v1->
append(Util::createNullConstant(DT_LONG)
);
v1->
replace(Util::createNullConstant(DT_LONG), Util::createLong(4)
);
v1->
replace(Util::createLong(-2), Util::createNullConstant(DT_LONG)
);
v1->
replace(Util::createLong(-1), Util::createLong(3)
);
EXPECT_EQ(v1
->
...
->validIndex(0, 1, 1));
EXPECT_FALSE(v1
->validIndex(0, 1, (short) 0));

VectorSP subv1 = Util::createVector(DT_SHORT, 0, 2);
subv1->
append(Util::createShort(1)
);
subv1->
append(Util::createShort(2)
);
EXPECT_FALSE(v1
->compare(0, Util::createShort(1)));

VectorSP indexVec = Util::createIndexVector(0, 1);
ConstantSP index = Util::createInt(0);
subv1->
set(indexVec, Util::createShort(3)
);
EXPECT_EQ(subv1
->get(0)->
...
(short) 5);
subv1->
set(index, Util::createNullConstant(DT_SHORT)
);
EXPECT_TRUE(subv1
->get(0)->
...
->getInt(1), (int) 2);
EXPECT_EQ(v1
->getLong(1), (long long) 2);

EXPECT_ANY_THROW(v1
->fill(1, 1, Util::createString("1")));
EXPECT_FALSE(v1
->validIndex(0, 1, (float) 0));

VectorSP subv1 = Util::createVector(DT_FLOAT, 0, 2);
subv1->
append(Util::createFloat(1)
);
subv1->
append(Util::createFloat(2)
);
EXPECT_EQ(v1
->compare(0, Util::createFloat(1)), 0);
EXPECT_EQ(v1
->compare(0, Util::createFloat(0)), 1);
EXPECT_EQ(v1
->compare(0, Util::createFloat(3)), -1);

VectorSP indexVec = Util::createIndexVector(0, 1);
ConstantSP index = Util::createFloat(0);
subv1->
set(indexVec, Util::createFloat(3)
);
EXPECT_EQ(subv1
->get(0)->
...
(float) 5);
subv1->
set(index, Util::createNullConstant(DT_FLOAT)
);
EXPECT_TRUE(subv1
->get(0)->
...
subv1->set(1,
Util::createNullConstant(DT_FLOAT)
);
EXPECT_TRUE(subv1
->get(1)->
...
v2->set(1, Util::createFloat((
float) 3));
v2->
append(Util::createNullConstant(DT_FLOAT)
);

v2->
replace(Util::createNullConstant(DT_FLOAT), Util::createFloat(4)
);
v2->
replace(Util::createFloat((float) 3), Util::createNullConstant(DT_FLOAT)
);
v2->
replace(Util::createFloat(1), Util::createLong(3)
);
EXPECT_EQ(v2
->
...
EXPECT_ANY_THROW(v2
->
asof(Util::createVector(DT_FLOAT, 0, 1)
));
EXPECT_EQ(v2
->
asof(Util::createFloat(2)
), -1);
EXPECT_EQ(v2
->
asof(Util::createFloat(3.1)
), 0);
...
subv1->
append(Util::createDouble(1)
);
subv1->
append(Util::createDouble(2)
);
EXPECT_EQ(v1
->compare(0, Util::createDouble(1)), 0);
EXPECT_EQ(v1
->compare(0, Util::createDouble(0)), 1);
EXPECT_EQ(v1
->compare(0, Util::createDouble(3)), -1);

VectorSP indexVec = Util::createIndexVector(0, 1);
ConstantSP index = Util::createDouble(0);
subv1->
set(indexVec, Util::createDouble(3)
);
EXPECT_EQ(subv1
->get(0)->
...
(float) 5);
subv1->
set(index, Util::createNullConstant(DT_DOUBLE)
);
EXPECT_TRUE(subv1
->get(0)->
...
subv1->set(1,
Util::createNullConstant(DT_DOUBLE)
);
EXPECT_TRUE(subv1
->get(1)->
...
"[2,3.3131,3.3114]");
v1->
append(Util::createNullConstant(DT_DOUBLE)
);
v1->add(0, 3, (double) 1);
EXPECT_EQ(v1
->
...
v1->
append(Util::createNanoTime(86400000000000ll)
);
v1->
...
v1->
append(Util::createSecond(86400)
);
v1->
...
->compare(0,
Util::parseConstant(DT_INT128,
"e1671797c52e15f763380b45e841ec33")), 0);
v1->
replace(Util::parseConstant(DT_INT128, "e1671797c52e15f763380b45e841ec33"), Util::parseConstant(DT_INT128,
                                                                                                "e1671797c52e15f763380b45e841ec55")
);
EXPECT_EQ(v1
->get(0)->
...
v1->
append(Util::createNullConstant(DT_INT128)
);
EXPECT_ANY_THROW(v1
->
nullFill(Util::createInt(1)
));
v1->
nullFill(Util::parseConstant(DT_INT128, "e1671797c52e15f763380b45e841ec99")
);
EXPECT_EQ(v1
->get(2)->
...
"e1671797c52e15f763380b45e841ec99");
...
v1->
appendString(pstrEmpty,
1);
EXPECT_EQ(v1
->get(3)->

getString(), Util::createNullConstant(DT_INT128)
...
EXPECT_FALSE(v1
->
appendString(pstrlt32,
1));
v1->
appendString(pint128str,
1);
EXPECT_EQ(v1
->get(4)->
...
instanceVec->set(0,
Util::parseConstant(DT_INT128,
"e1671797c52e15f763380b45e841ec00"));
EXPECT_EQ(instanceVec
->
...
valVec->set(0,
Util::parseConstant(DT_INT128,
"e1671797c52e15f763380b45e841ec66"));
valVec->set(1,
Util::parseConstant(DT_INT128,
"e1671797c52e15f763380b45e841ec77"));
EXPECT_FALSE(v1
->
set(index, Util::createInt(4)
));
v1->
set(index, Util::parseConstant(DT_INT128, "e1671797c52e15f763380b45e841ec88")
);
EXPECT_EQ(v1
->get(3)->
...
"e1671797c52e15f763380b45e841ec88");
v1->
set(index, Util::createNullConstant(DT_INT128)
);
EXPECT_TRUE(v1
->get(3)->
...
"[e1671797c52e15f763380b45e841ec55,e1671797c52e15f763380b45e841ec66,e1671797c52e15f763380b45e841ec77,,e1671797c52e15f763380b45e841ec00,,e1671797c52e15f763380b45e841ec00]");
...
"[e1671797c52e15f763380b45e841ec55,,e1671797c52e15f763380b45e841ec00,,e1671797c52e15f763380b45e841ec00]");
EXPECT_FALSE(instanceVec
->remove(10));
...
"[e1671797c52e15f763380b45e841ec55,,e1671797c52e15f763380b45e841ec00,]");
instanceVec->remove(-1);
EXPECT_EQ(instanceVec
->
...
"[e1671797c52e15f763380b45e841ec00,,e1671797c52e15f763380b45e841ec00,,,,]");
v1->prev(4);
EXPECT_EQ(v1
->
...
i < 7; i++)
valVec2->
set(i, Util::parseConstant(DT_INT128, "e1671797c52e15f763380b45e841ec" + to_string(4 * 10 + i))
);
...
int *buf3 = new int[1];
buf3[0] = 1;
EXPECT_TRUE(instanceVec
->setData(1, 1, v1->getDataBuffer(0, 1, buf3)));
EXPECT_EQ(instanceVec
->

getString(),

"[,e1671797c52e15f763380b45e841ec40,]");
...
->compare(0,
Util::parseConstant(DT_UUID,
"5d212a78-cc48-e3b1-4235-b4d91473ee87")), 1);
v1->
replace(Util::parseConstant(DT_UUID, "5d212a78-cc48-e3b1-4235-b4d91473ee87"), Util::parseConstant(DT_UUID,
                                                                                                  "5d212a78-cc48-e3b1-4235-b4d91473ee99")
);
EXPECT_EQ(v1
->get(1)->
...
v1->
append(Util::createNullConstant(DT_UUID)
);
EXPECT_ANY_THROW(v1
->
nullFill(Util::createInt(1)
...
v1->
nullFill(Util::parseConstant(DT_UUID, "5d212a78-cc48-e3b1-4235-b4d91473ee99")
);
EXPECT_EQ(v1
->get(2)->
...
getString(), Util::createNullConstant(DT_UUID)
...
EXPECT_FALSE(v1
->
appendString(pstrlt36,
1));
v1->
appendString(puuidstr,
1);
EXPECT_EQ(v1
->get(4)->
...
"192.168.1.13")), 1);
v1->
replace(Util::parseConstant(DT_IP, "192.168.1.13"), Util::parseConstant(DT_IP, "192.168.1.255")
);
EXPECT_EQ(v1
->get(1)->
...
v1->
append(Util::createNullConstant(DT_IP)
);
EXPECT_ANY_THROW(v1
->
nullFill(Util::createInt(1)
...
v1->
nullFill(Util::parseConstant(DT_IP, "192.168.1.255")
);
EXPECT_EQ(v1
->get(2)->
...
getString(), Util::createNullConstant(DT_IP)
...
EXPECT_EQ(v1
->
asof(Util::createString("sym1")
), 0);
EXPECT_EQ(v1
->
asof(Util::createString("sym2")
), 1);
...
EXPECT_EQ(v1
->compare(1, Util::createString("sym2")), 0);
EXPECT_EQ(v1
->
...
getString(), Util::createString("sym2")
...
getString(), Util::createString("sym1")
...
v1->
nullFill(Util::createString("sym3")
);
EXPECT_EQ(v1
->get(2)->
...
v1->
replace(Util::createString(""), Util::createString("replaceVal")
);
...
v1->
set(indexVal, Util::createNullConstant(DT_STRING)
);
v1->
set(indexVec, Util::createString("indexVec")
);
v1->
set(intIndexVec, Util::createString("intIndexVec")
);
EXPECT_TRUE(v1
->
...
"[,\"indexVec\",\"intIndexVec\",\"sym4\",\"replaceVal\",\"sym5\",\"replaceVal\"]");
...
"[\"value1\",\"[\\\"vec1\\\",]\",\"[\\\"vec2\\\"]\",\"[\\\"vec2\\\"]\",\"vec1\",,\"replaceVal\"]");
...
EXPECT_ANY_THROW(VectorSP
v0 = Util::createVector(DT_DECIMAL32, 2, 2, true, 10)
);
...
EXPECT_EQ(Util::getCategoryString(v1->getCategory()),
"DENARY");
EXPECT_EQ(v1
->
...
float buf1[1];
EXPECT_EQ(v1
->getFloat(1), res_v->get(1)->

getFloat()

);
v1->getFloat(0, 1, buf1);
EXPECT_EQ((float) buf1[0], res_v->get(0)->
...
double buf2[1];
EXPECT_EQ(v1
->getDouble(1), res_v->get(1)->

getDouble()

);
v1->getDouble(0, 1, buf2);
EXPECT_EQ((double) buf2[0], res_v->get(0)->
...
diffScalevalV->set(1,
Util::createNullConstant(DT_DECIMAL32)
);
...
v1->
append(Util::createDecimal32(2, 1.5)
);
v1->set(2,
Util::createNullConstant(DT_DECIMAL32)
);
...
3));
v1->
append(Util::createDecimal32(2, 3.12123),
1);
EXPECT_EQ(v1
->
...
"[1.20,3.15,,3.12]");
v1->
append(Util::createNullConstant(DT_DECIMAL32),
1);
EXPECT_EQ(v1
->
...
"[1.20,3.15,,3.12,,1.00,,13.00,]");
EXPECT_ANY_THROW(v1
->
appendString(charerrbuf,
1));
v1->
appendString(charbuf,
3);
EXPECT_EQ(v1
->
...
"[1.20,3.15,,3.12,,1.00,,13.00,,9.48,84912.39,31945.10]");
EXPECT_ANY_THROW(v1
->
appendString(strerrbuf,
1));
v1->
appendString(strbuf,
2);
...
"[1.20,3.15,,3.12,,1.00,,13.00,,9.48,84912.39,31945.10,0.00,-1356.14]");

conn.upload("v1", v1);
EXPECT_TRUE(conn
.run("eqObj(v1,decimal32([1.20,3.15,NULL,3.12,NULL,1.00,NULL,13.00,NULL,9.48,84912.39,31945.10,0.00,-1356.14],2))")->
...
v1->
nullFill(Util::createFloat(4.3335)
);
EXPECT_EQ(v1
->
...
"[1.20,3.15,4.33,3.12,4.33,1.00,4.33,13.00,4.33,9.48,84912.39,31945.10,0.00,-1356.14]");
...
EXPECT_TRUE(v2
->
set(Util::createInt(0), Util::createDecimal32(2, 2.7999)
));
EXPECT_ANY_THROW(v2
->
set(Util::createIndexVector(1, 1), errTypevalV
));
v2->
set(Util::createIndexVector(1, 1), diffScalevalV
);
EXPECT_EQ(v2
->
...
EXPECT_EQ(v2
->compare(0, Util::createInt(12)), 1);
EXPECT_EQ(v2
->compare(1, Util::createInt(1)), -1);
EXPECT_EQ(v2
->compare(1, Util::createInt(0)), 0);
EXPECT_EQ(v2
->compare(0, Util::createDecimal32(3, 12.99)), 1);
EXPECT_EQ(v2
->compare(0, Util::createDecimal32(2, 13.01)), -1);
EXPECT_EQ(v2
->compare(1, Util::createDecimal32(1, 0)), 0);
EXPECT_EQ(v2
->compare(0, Util::createDecimal64(8, 12.999999999)), 1);
EXPECT_EQ(v2
->compare(0, Util::createDecimal64(10, 13.00001)), -1);
EXPECT_EQ(v2
->compare(1, Util::createDecimal64(1, 0)), 0);
EXPECT_ANY_THROW(v2
->compare(0, Util::createBlob("blob1")));
v2->
nullFill(Util::createInt(1)
);
}
...
EXPECT_ANY_THROW(VectorSP
v0 = Util::createVector(DT_DECIMAL64, 2, 2, true, 19)
);
...
diffScalevalV->set(1,
Util::createNullConstant(DT_DECIMAL64)
);
string strbuf[2] = {"0", "-1356.14655"};
string strerrbuf[1] = {"abcdefg"};
char *charbuf[3] = {(char *) "9.4856", (char *) "84912.39123", (char *) "31945.1"};
...
v1->
append(Util::createDecimal64(2, 1.5)
);
v1->set(2,
Util::createNullConstant(DT_DECIMAL64)
);
...
3));
v1->
append(Util::createDecimal64(2, 3.12123),
1);
EXPECT_EQ(v1
->
...
"[1.20,3.15,,3.12]");
v1->
append(Util::createNullConstant(DT_DECIMAL64),
1);
EXPECT_EQ(v1
->
...
conn.upload("v1", v1);
EXPECT_TRUE(conn
.run("eqObj(v1,decimal64([1.20,3.15,NULL,3.12,NULL,1.00,NULL,13.00,NULL,9.48,84912.39,31945.10,0.00,-1356.14],2))")->
...
EXPECT_TRUE(v2
->
set(Util::createInt(0), Util::createDecimal64(2, 2.7999)
));
EXPECT_ANY_THROW(v2
->
set(Util::createIndexVector(1, 1), errTypevalV
...
v3.
appendString(appendbuf1, size
);
v3.
appendString(appendconstbuf1,
1);
...
v4.
appendString(appendbuf2, size
);
v4.
appendString(appendconstbuf2,
1);
...
i < 70000; i++) {
v1->
set(i, Util::createString(to_string(i))
);
}
...
i < 70000; i++) {
v1->
set(i, Util::createNanoTimestamp(i)
);
}
...
table = Util::createTable(
        {"double", "float", "int", "short", "long", "bool", "char", "str", "int128", "uuid", "ip", "blob", "date",
         "minute", "datetime", "nanotime", "datehour", "decimal32", "decimal64", "symbol"},
        {doubleV.createVector(DT_DOUBLE), floatV.createVector(DT_FLOAT), intV.createVector(DT_INT),
         shortV.createVector(DT_SHORT),
         longV.createVector(DT_LONG), boolV.createVector(DT_BOOL), charV.createVector(DT_CHAR),
         strV.createVector(DT_STRING),
         int128V.createVector(DT_INT128), uuidV.createVector(DT_UUID), ipV.createVector(DT_IP),
         blobV.createVector(DT_BLOB),
         dateV.createVector(DT_DATE), minuteV.createVector(DT_MINUTE), datetimeV.createVector(DT_DATETIME),
         nanotimeV.createVector(DT_NANOTIME),
         datehourV.createVector(DT_DATEHOUR), decimal32V.createVector(DT_DECIMAL32),
         decimal64V.createVector(DT_DECIMAL64), symV.createVector(DT_SYMBOL)});
...
cols[colIndex++] =
Util::createVector(DT_DECIMAL32,
0, table->
...
cols[colIndex++] =
Util::createVector(DT_DECIMAL64,
0, table->
...
EXPECT_TRUE(stringV
->isNull(0, size, buf0));
EXPECT_FALSE(stringV
->isValid(0, size, buf0));
EXPECT_FALSE(stringV
->getBool(0, size, buf00));
EXPECT_FALSE(stringV
->getChar(0, size, buf));
EXPECT_FALSE(stringV
->getShort(0, size, buf1));
EXPECT_FALSE(stringV
->getInt(0, size, buf2));
EXPECT_FALSE(stringV
->getLong(0, size, buf3));
EXPECT_FALSE(stringV
->getIndex(0, size, buf4));
EXPECT_FALSE(stringV
->getFloat(0, size, buf5));
EXPECT_FALSE(stringV
->getDouble(0, size, buf6));
EXPECT_FALSE(stringV
->getSymbol(0, size, buf2, symbase, false));
EXPECT_FALSE(stringV
->getBinary(0, size, size, buf10));
EXPECT_TRUE(stringV
->getHash(0, size, buckets, buf2));
cout << stringV->
getAllocatedMemory(size)
<<
endl;
EXPECT_ANY_THROW(stringV
->getBoolConst(0, size, buf)[0]);
EXPECT_ANY_THROW(stringV
->getCharConst(0, size, buf)[0]);
EXPECT_ANY_THROW(stringV
->getShortConst(0, size, buf1)[0]);
EXPECT_ANY_THROW(stringV
->getIntConst(0, size, buf2)[0]);
EXPECT_ANY_THROW(stringV
->getLongConst(0, size, buf3)[0]);
EXPECT_ANY_THROW(stringV
->getIndexConst(0, size, buf4)[0]);
EXPECT_ANY_THROW(stringV
->getFloatConst(0, size, buf5)[0]);
EXPECT_ANY_THROW(stringV
->getDoubleConst(0, size, buf6)[0]);
EXPECT_ANY_THROW(stringV
->getSymbolConst(0, size, buf2, symbase, false));
stringV->getStringConst(0, size, buf8);
for (
auto i = 0;
i<size;
i++)
EXPECT_EQ(*(buf8[i]), stringval
->
...
EXPECT_ANY_THROW(stringV
->getBinaryConst(0, size, sizeof(string), buf10));
...
0);
EXPECT_EQ(symV
->getBoolConst(0, size, buf)[0], 1);
EXPECT_EQ(symV
->getCharConst(0, size, buf)[0], 1);
EXPECT_EQ(symV
->getShortConst(0, size, buf1)[0], 1);
EXPECT_EQ(symV
->getIntConst(0, size, buf2)[0], 1);
EXPECT_EQ(symV
->getLongConst(0, size, buf3)[0], 1);
EXPECT_EQ(symV
->getIndexConst(0, size, buf4)[0], 1);
EXPECT_EQ(symV
->getFloatConst(0, size, buf5)[0], 1);
EXPECT_EQ(symV
->getDoubleConst(0, size, buf6)[0], 1);
EXPECT_EQ(symV
->getCharConst(0, size, buf)[1], 2);
EXPECT_EQ(symV
->getShortConst(0, size, buf1)[1], 2);
EXPECT_EQ(symV
->getIntConst(0, size, buf2)[1], 2);
EXPECT_EQ(symV
->getLongConst(0, size, buf3)[1], 2);
EXPECT_EQ(symV
->getIndexConst(0, size, buf4)[1], 2);
EXPECT_EQ(symV
->getFloatConst(0, size, buf5)[1], 2);
EXPECT_EQ(symV
->getDoubleConst(0, size, buf6)[1], 2);
EXPECT_ANY_THROW(symV
->getSymbolConst(0, size, buf2, symbase, false));
...
->getSymbol(0, size, buf2, symbase, false));
EXPECT_FALSE(intV
->getBinary(0, size, sizeof(int), buf10));
EXPECT_TRUE(intV
->getHash(0, size, buckets, buf2));
EXPECT_EQ(intV
->
...
i++) {
EXPECT_EQ(intV
->getBoolConst(0, size, buf)[i], 1);
EXPECT_EQ(intV
->getCharConst(0, size, buf)[i], '\xA0');
// EXPECT_EQ(intV->getShortConst(0,size,buf1)[i], SHRT_MIN);
EXPECT_EQ(intV
->getIntConst(0, size, buf2)[i], 100000);
EXPECT_EQ(intV
->getLongConst(0, size, buf3)[i], 100000);
EXPECT_EQ(intV
->getIndexConst(0, size, buf4)[i], 100000);
EXPECT_EQ(intV
->getFloatConst(0, size, buf5)[i], 100000);
EXPECT_EQ(intV
->getDoubleConst(0, size, buf6)[i], 100000);
}
EXPECT_ANY_THROW(intV
->getSymbolConst(0, size, buf2, symbase, false));
EXPECT_ANY_THROW(intV
->getStringConst(0, size, buf8));
EXPECT_ANY_THROW(intV
->getStringConst(0, 24, buf9));
EXPECT_ANY_THROW(intV
->getBinaryConst(0, size, sizeof(int), buf10));
...
i++) {
EXPECT_EQ(intV
->getBoolBuffer(0, size, buf)[i], '\xA0');
EXPECT_EQ(intV
->getCharBuffer(0, size, buf)[i], '\xA0');
// EXPECT_EQ(intV->getShortBuffer(0,size,buf1)[0], SHRT_MIN);
EXPECT_EQ(intV
->getIntBuffer(0, size, buf2)[i], 100000);
EXPECT_EQ(intV
->getLongBuffer(0, size, buf3)[i], 100000);
EXPECT_EQ(intV
->getIndexBuffer(0, size, buf4)[i], 100000);
EXPECT_EQ(intV
->getFloatBuffer(0, size, buf5)[i], 100000);
EXPECT_EQ(intV
->getDoubleBuffer(0, size, buf6)[i], 100000);
}
...
->getBoolConst(0, size, buf)[i], 1);
EXPECT_EQ(charV
->getCharConst(0, size, buf)[i], rand_val);
EXPECT_EQ(charV
->getShortConst(0, size, buf1)[i], (short) rand_val);
EXPECT_EQ(charV
->getIntConst(0, size, buf2)[i], (int) rand_val);
EXPECT_EQ(charV
->getLongConst(0, size, buf3)[i], (long long) rand_val);
EXPECT_EQ(charV
->getIndexConst(0, size, buf4)[i], (INDEX) rand_val);
EXPECT_EQ(charV
->getFloatConst(0, size, buf5)[i], (float) rand_val);
EXPECT_EQ(charV
->getDoubleConst(0, size, buf6)[i], (double) rand_val);
}

EXPECT_ANY_THROW(charV
->getSymbolConst(0, size, buf2, symbase, false));
EXPECT_ANY_THROW(charV
->getStringConst(0, size, buf8)[0]);
EXPECT_ANY_THROW(charV
->getStringConst(0, 24, buf9));
EXPECT_ANY_THROW(charV
->getBinaryConst(0, size, sizeof(char), buf10));
...
i++) {
EXPECT_EQ(charV
->getBoolBuffer(0, size, buf)[i], (bool) rand_val);
EXPECT_EQ(charV
->getCharBuffer(0, size, buf)[i], rand_val);
EXPECT_EQ(charV
->getShortBuffer(0, size, buf1)[i], (short) rand_val);
EXPECT_EQ(charV
->getIntBuffer(0, size, buf2)[i], (int) rand_val);
EXPECT_EQ(charV
->getLongBuffer(0, size, buf3)[i], (long) rand_val);
EXPECT_EQ(charV
->getIndexBuffer(0, size, buf4)[i], (INDEX) rand_val);
EXPECT_EQ(charV
->getFloatBuffer(0, size, buf5)[i], (float) rand_val);
EXPECT_EQ(charV
->getDoubleBuffer(0, size, buf6)[i], (double) rand_val);
}
...
EXPECT_EQ(shortV
->getShortConst(0, size, buf1)[i], (short) rand_val2);
EXPECT_EQ(shortV
->getIntConst(0, size, buf2)[i], (int) rand_val2);
EXPECT_EQ(shortV
->getLongConst(0, size, buf3)[i], (long long) rand_val2);
EXPECT_EQ(shortV
->getIndexConst(0, size, buf4)[i], (INDEX) rand_val2);
EXPECT_EQ(shortV
->getFloatConst(0, size, buf5)[i], (float) rand_val2);
EXPECT_EQ(shortV
->getDoubleConst(0, size, buf6)[i], (double) rand_val2);
}

EXPECT_ANY_THROW(shortV
->getSymbolConst(0, size, buf2, symbase, false));
EXPECT_ANY_THROW(shortV
->getStringConst(0, size, buf8)[0]);
EXPECT_ANY_THROW(shortV
...
EXPECT_EQ(shortV
->getShortBuffer(0, size, buf1)[i], (short) rand_val2);
EXPECT_EQ(shortV
->getIntBuffer(0, size, buf2)[i], (int) rand_val2);
EXPECT_EQ(shortV
->getLongBuffer(0, size, buf3)[i], (long) rand_val2);
EXPECT_EQ(shortV
->getIndexBuffer(0, size, buf4)[i], (INDEX) rand_val2);
EXPECT_EQ(shortV
->getFloatBuffer(0, size, buf5)[i], (float) rand_val2);
EXPECT_EQ(shortV
->getDoubleBuffer(0, size, buf6)[i], (double) rand_val2);
}
...
EXPECT_EQ(longV
->getIntConst(0, size, buf2)[i], (int) rand_val3);
EXPECT_EQ(longV
->getLongConst(0, size, buf3)[i], (long long) rand_val3);
EXPECT_EQ(longV
->getIndexConst(0, size, buf4)[i], (INDEX) rand_val3);
EXPECT_EQ(longV
->getFloatConst(0, size, buf5)[i], (float) rand_val3);
EXPECT_EQ(longV
->getDoubleConst(0, size, buf6)[i], (double) rand_val3);
}

EXPECT_ANY_THROW(longV
->getSymbolConst(0, size, buf2, symbase, false));
EXPECT_ANY_THROW(longV
->getStringConst(0, size, buf8)[0]);
EXPECT_ANY_THROW(longV
...
EXPECT_EQ(longV
->getIntBuffer(0, size, buf2)[i], (int) rand_val3);
EXPECT_EQ(longV
->getLongBuffer(0, size, buf3)[i], (long) rand_val3);
EXPECT_EQ(longV
->getIndexBuffer(0, size, buf4)[i], (INDEX) rand_val3);
EXPECT_EQ(longV
->getFloatBuffer(0, size, buf5)[i], (float) rand_val3);
EXPECT_EQ(longV
->getDoubleBuffer(0, size, buf6)[i], (double) rand_val3);
}
...
EXPECT_EQ(floatV
->getShortConst(0, size, buf1)[i], floatV->
get(i)
->
...
EXPECT_EQ(floatV
->getIntConst(0, size, buf2)[i], floatV->
get(i)
->
...
EXPECT_EQ(floatV
->getLongConst(0, size, buf3)[i], floatV->
get(i)
->
...
EXPECT_EQ(floatV
->getIndexConst(0, size, buf4)[i], floatV->
get(i)
->
...
EXPECT_EQ(floatV
->getFloatConst(0, size, buf5)[i], floatV->
get(i)
->
...
EXPECT_EQ(floatV
->getDoubleConst(0, size, buf6)[i], floatV->
get(i)
->
...
EXPECT_EQ(floatV
->getShortBuffer(0, size, buf1)[i], floatV->
get(i)
->
...
EXPECT_EQ(floatV
->getIntBuffer(0, size, buf2)[i], floatV->
get(i)
->
...
EXPECT_EQ(floatV
->getLongBuffer(0, size, buf3)[i], floatV->
get(i)
->
...
EXPECT_EQ(floatV
->getIndexBuffer(0, size, buf4)[i], floatV->
get(i)
->
...
EXPECT_EQ(floatV
->getFloatBuffer(0, size, buf5)[i], floatV->
get(i)
->
...
EXPECT_EQ(floatV
->getDoubleBuffer(0, size, buf6)[i], floatV->
get(i)
->
...
EXPECT_EQ(doubleV
->getShortConst(0, size, buf1)[i], doubleV->
get(i)
->
...
EXPECT_EQ(doubleV
->getIntConst(0, size, buf2)[i], doubleV->
get(i)
->
...
EXPECT_EQ(doubleV
->getLongConst(0, size, buf3)[i], doubleV->
get(i)
->
...
EXPECT_EQ(doubleV
->getIndexConst(0, size, buf4)[i], doubleV->
get(i)
->
...
EXPECT_EQ(doubleV
->getFloatConst(0, size, buf5)[i], doubleV->
get(i)
->
...
EXPECT_EQ(doubleV
->getDoubleConst(0, size, buf6)[i], doubleV->
get(i)
->
...
EXPECT_EQ(doubleV
->getShortBuffer(0, size, buf1)[i], doubleV->
get(i)
->
...
EXPECT_EQ(doubleV
->getIntBuffer(0, size, buf2)[i], doubleV->
get(i)
->
...
EXPECT_EQ(doubleV
->getLongBuffer(0, size, buf3)[i], doubleV->
get(i)
->
...
EXPECT_EQ(doubleV
->getIndexBuffer(0, size, buf4)[i], doubleV->
get(i)
->
...
EXPECT_EQ(doubleV
->getFloatBuffer(0, size, buf5)[i], doubleV->
get(i)
->
...
EXPECT_EQ(doubleV
->getDoubleBuffer(0, size, buf6)[i], doubleV->
get(i)
->
...
delete[] buf, buf1, buf2, buf3, buf4, buf5, buf6, buf9, buf10, buf00, buf0,
buf8;
}