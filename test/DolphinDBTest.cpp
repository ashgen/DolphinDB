...
void ASSERTION(const string &test, const T &ret, const T &expect) {
    if (ret != expect) {
        std::cout << "ASSERT FAIL--" << test << "-- expect return --" << (T) expect << ", real return--" << (T) ret
                  << std::endl;
        fail++;
    } else
...
void testDatehourVector() {
    ...
    vector<string> expectResults = {"2021.05.01T11", "2021.05.01T20", "2021.05.05T14", "2021.06.12T02", "2022.06.22T02",
                                    "2032.09.27T02"};
...
void testDatetimeVector() {
    ...
    vector<string> expectResults = {"2012.10.01T15:00:05", "2012.10.01T15:01:44", "2012.10.01T15:16:44",
                                    "2012.10.01T17:46:44", "2012.10.02T18:46:44", "2012.10.13T04:46:44",
                                    "2013.01.25T08:46:44"};
    string script;
    for (int testValue: testValues) {
        script += " " + std::to_string(testValue);
...
void testTimeStampVector() {
    ...
    vector<long long> testValues = {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000,
                                    10000000000, 100000000000, 1000000000000};
    vector<string> expectResults = {"2009.10.12T00:00:00.001", "2009.10.12T00:00:00.010", "2009.10.12T00:00:00.100",
                                    "2009.10.12T00:00:01.000", "2009.10.12T00:00:10.000", "2009.10.12T00:01:40.000",
                                    "2009.10.12T00:16:40.000",
                                    "2009.10.12T02:46:40.000", "2009.10.13T03:46:40.000", "2009.10.23T13:46:40.000",
                                    "2010.02.04T17:46:40.000",
...
void testnanotimeVector() {
    ...
    vector<string> expectResults = {"13:30:10.008007007", "13:30:10.008007016", "13:30:10.008007106",
                                    "13:30:10.008008006", "13:30:10.008017006", "13:30:10.008107006",
                                    "13:30:10.009007006",
                                    "13:30:10.018007006", "13:30:10.108007006", "13:30:11.008007006",
                                    "13:30:20.008007006",
...
void testnanotimestampVector() {
    ...
    vector<string> expectResults = {"2012.06.13T13:30:10.008007007", "2012.06.13T13:30:10.008007016",
                                    "2012.06.13T13:30:10.008007106",
                                    "2012.06.13T13:30:10.008008006", "2012.06.13T13:30:10.008017006",
                                    "2012.06.13T13:30:10.008107006", "2012.06.13T13:30:10.009007006",
                                    "2012.06.13T13:30:10.018007006", "2012.06.13T13:30:10.108007006",
                                    "2012.06.13T13:30:11.008007006", "2012.06.13T13:30:20.008007006",
                                    "2012.06.13T13:31:50.008007006", "2012.06.13T13:46:50.008007006",
                                    "2012.06.13T16:16:50.008007006", "2012.06.14T17:16:50.008007006",
                                    "2012.06.25T03:16:50.008007006", "2012.10.07T07:16:50.008007006",
                                    "2015.08.14T23:16:50.008007006"};
    string script;
    for (long long testValue: testValues) {
        script += " " + std::to_string(testValue);
    }
...
void testtimeVector() {
    ...
    vector<string> expectResults = {"13:30:10.009", "13:30:10.018", "13:30:10.108", "13:30:11.008", "13:30:20.008",
                                    "13:31:50.008", "13:46:50.008", "16:16:50.008"};
    string script;
    for (int testValue: testValues) {
        script += " " + std::to_string(testValue);
    }
...
void testSymbolSmall() {
    ...
    conn.run(
            "t=table(symbol(string(1..200)) as sym,symbol(string(1..200)) as sym1,symbol(string(1..200)) as sym2,symbol(string(1..200)) as sym3,symbol(string(1..200)) as sym4,symbol(string(1..200)) as sym5,symbol(string(1..200)) as sym6,symbol(string(1..200)) as sym7,symbol(string(1..200)) as sym8,symbol(string(1..200)) as sym9)");
    startTime = getTimeStampMs();
    conn.run("t");
    time = getTimeStampMs() - startTime;
    cout << "table with same symbol vectors：" << time << "ms" << endl;
...
void testSymbolNull() {
    ...
    conn.run(
            "t=table(take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym1,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym2,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym3,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym4,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym5,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym6,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym7,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym8,take(symbol(`cy`fty``56e`f65dfyfv),2000000) as sym9)");
    startTime = getTimeStampMs();
    conn.run("t");
    time = getTimeStampMs() - startTime;
    cout << "table with same symbol vectors：" << time << "ms" << endl;
    ...
    conn.run(
            "t=table(take(symbol(`cdwy`fty``56e`f652dfyfv),2000000) as sym,take(symbol(`cy`f8ty``56e`f65dfyfv),2000000) as sym1,take(symbol(`c2587y`fty``56e`f65dfyfv),2000000) as sym2,take(symbol(`cy````f65dfy4fv),2000000) as sym3,take(symbol(`cy```56e`f65dfgyfv),2000000) as sym4,take(symbol(`cy`fty``56e`12547),2000000) as sym5,take(symbol(`cy`fty``e`f65d728fyfv),2000000) as sym6,take(symbol(`cy`fty``56e`),2000000) as sym7,take(symbol(`cy`fty``56e`111),2000000) as sym8,take(symbol(`c412y`ft575y```f65dfyfv),2000000) as sym9)");
    startTime = getTimeStampMs();
    conn.run("t");
    time = getTimeStampMs() - startTime;
    cout << "table with diff symbol vectors：" << time << "ms" << endl;
...
void testStringVectorHash() {
    vector<string> testValues{"9223372036854775807", "helloworldabcdefghijklmnopqrstuvwxyz", "智臾科技",
                              "hello,智臾科技", "123abc您好！", ""};
    int buckets[5] = {13, 43, 71, 97, 4097};
    int expected[5][6] = {
            {8,   1,    11,  8,    10,   0},
...
void test_symbol_optimization() {
    ...
    vector<DATA_TYPE> colTypes = {DT_SYMBOL, DT_SYMBOL, DT_SYMBOL, DT_SYMBOL, DT_SYMBOL, DT_SYMBOL, DT_SYMBOL,
                                  DT_SYMBOL, DT_SYMBOL, DT_SYMBOL};
...
void test_AutoFitTableAppender_convert_to_minute() {
    ...
    vector<DATA_TYPE> colTypes = {DT_DATETIME, DT_TIMESTAMP, DT_NANOTIMESTAMP, DT_TIME, DT_SECOND, DT_MINUTE,
                                  DT_NANOTIME};
...
void test_batchTableWriter_insert() {
    ...
    conn.run(expected1);
    try {
        btw.insert("table1", "", int(0), int(0), short(100), strtest, string("test"), testlong, testlong, testlong,
                   testlong, float(100), double(100), int(100), int(100), int(100), int(100), int(100), int(100),
                   int(100), int(100));
    ...
    try {
        btw.insert("table1", "", char('0'), char('t'), short(100), strtest, string("test"), testlong, testlong,
                   testlong, testlong, float(100), double(100), int(100), int(100), int(100), int(100), int(100),
    ...
    for (int i = 0; i < 1000; i++) {
        btw.insert("dfs://test_batchTableWriter", "dtable", char('0'), char('t'), short(100), strtest, string("test"),
                   testlong, testlong, testlong, testlong, float(100), double(100), int(100), int(100), int(100),
                   int(100), int(100), int(100), int(100), int(100));
    }
    for (int j = 0; j < 20; j++) {
        TableSP result = btw.getAllStatus();
        if (result->getColumn(3)->getString(0).c_str() == to_string(1000)) break;
    ...
    int result2 = 0;
    for (int i = 0; i < 1000; i++) {
        string script = "dt=loadTable('dfs://test_batchTableWriter', 'dtable'); eqObj(( select * from dt)[" +
                        std::to_string(i) + "].values(),expected[0].values());";
    ...
    for (int i = 0; i < 1000; i++) {
        btw.insert("dfs://test_batchTableWriter", "ptable", char('0'), char('t'), short(100), strtest, string("test"),
                   testlong, testlong, testlong, testlong, float(100), double(100), int(100), int(100), int(100),
                   int(100), int(100), int(100), int(100), int(100));
    }
    for (int j = 0; j < 20; j++) {
    ...
    int result3 = 0;
    for (int i = 0; i < 1000; i++) {
        string script = "pt=loadTable('dfs://test_batchTableWriter', 'ptable'); eqObj(( select * from pt)[" +
                        std::to_string(i) + "].values(),expected[0].values());";
...
void test_batchTableWriter_insert_symbol_dfs() {
    ...
    for (int i = 0; i < 3000000; i++) {
        btw.insert("dfs://test_batchTableWriter_symbol", "pt", "A" + std::to_string(i % 10),
                   "B" + std::to_string(i % 10), "C" + std::to_string(i % 10));
    }
    for (int j = 0; j < 20; j++) {
        TableSP result = btw.getAllStatus();
        if (result->getColumn(3)->getString(0).c_str() == to_string(3000000)) break;
...
void test_batchTableWriter_insert_multithread_using_CPP_type(BatchTableWriter &btw, string dbName, string tableName,
                                                             bool partitionTable,
                                                             string assertStr, int testRow) {
    string script;
    DBConnection connNew(false, false);
    ...
    for (int i = 0; i < threadNum; ++i) {
        threadVec[i] = thread(test_batchTableWriter_insert_thread_fuction_using_cpp_type, i, ref(btw), dbName,
                              tableName, data);
    }
    for (int j = 0; j < 200; ++j) {
        TableSP t = btw.getAllStatus();
...
void test_batchTableWriter_insert_multithread_dfsTable_using_CPP_type() {
    BatchTableWriter btw(hostName, port, "admin", "123456", true);
    test_batchTableWriter_insert_multithread_using_CPP_type(ref(btw), "dfs://batchTableWriter", "batchTableWriter",
                                                            true,
...
void test_batchTableWriter_insert_unMultithread_dfsTable() {
    ...
    for (int i = 0; i < 4; ++i) {
        test_batchTableWriter_insert_unMultithread(ref(btw),
                                                   "dfs://batchTableWriter" + to_string(i),
                                                   "batchTableWriter" + to_string(i), true,
                                                   "test_batchTableWriter_insert_multithread_dfsTable" + to_string(i),
                                                   100000);
    }
    ConstantSP ret = conn.run("flag = array(BOOL, 0, 10);"
                              "for(idnum in 0..3){"
...
void test_batchTableWriter_insert_unMultithread_memoryTable() {
    ...
    for (int i = 0; i < 4; ++i) {
        test_batchTableWriter_insert_unMultithread(ref(btw), "batchTableWriter" + to_string(i), "",
                                                   true, "test_batchTableWriter_insert_multithread_memoryTable" +
                                                         to_string(i), 100000);
    }
    ConstantSP ret = conn.run("flag = array(BOOL, 0, 10);"
                              "for(idnum in 0..3){"
...
void test_BatchTableWriter_insert_error_type() {
    vector<string> type = {"BOOL", "CHAR", "SHORT", "STRING", "LONG", "NANOTIME", "NANOTIMESTAMP", "TIMESTAMP", "FLOAT",
                           "DOUBLE", "INT", "DATE", "MONTH", "TIME", "SECOND", "MINUTE", "DATETIME", "DATEHOUR",
                           "IPADDR", "INT128", "SYMBOL"};
    for (int i = 0; i < 18; ++i) {
        string script;
