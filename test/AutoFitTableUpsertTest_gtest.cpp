...
EXPECT_ANY_THROW(AutoFitTableUpsert
aftu("", "temp_tab", connNew));
}
...
columnVecs[2]->
set(i, Util::createInt((int) (rand() % 1000))
);
}
    aftu.upsert(tmp1);
...
EXPECT_EQ(res
->getRow(0)->
getMember(Util::createString("symbol")
)->
...
EXPECT_EQ(res
->getRow(0)->
getMember(Util::createString("id")
)->
