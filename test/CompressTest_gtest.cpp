...
timeVector->setInt(0, count, time.
...
VectorSP timeVector = Util::createVector(DT_DATE, count, count);
VectorSP valueVector = Util::createVector(DT_LONG, count, count);
timeVector->setInt(0, 0, time.

data()

);
valueVector->setLong(0, 0, value.
...
nameVector->setString(0, count, name.
...
vector <ConstantSP> colVector{timeVector, valueVector, nameVector};
TableSP table = Util::createTable(colName, colVector);
vector <COMPRESS_METHOD> typeVec{COMPRESS_METHOD::COMPRESS_DELTA, COMPRESS_METHOD::COMPRESS_LZ4,
                                 COMPRESS_METHOD::COMPRESS_LZ4};
    table->setColumnCompressMethods(typeVec);
...
boolVector->setInt(0, count, time.

data()

);
charVector->setInt(0, count, time.

data()

);
shortVector->setInt(0, count, time.

data()

);
intVector->setInt(0, count, time.

data()

);
dateVector->setInt(0, count, time.

data()

);
monthVector->setInt(0, count, time.
...
minuteVector->setInt(0, count, time.

data()

);
secondVector->setInt(0, count, time.

data()

);
datetimeVector->setLong(0, count, value.

data()

);
timestampVector->setLong(0, count, value.

data()

);
nanotimeVector->setLong(0, count, value.

data()

);
nanotimestampVector->setLong(0, count, value.

data()

);
floatVector->setFloat(0, count, cfloat.

data()

);
doubleVector->setFloat(0, count, cfloat.

data()

);
symbolVector->setString(0, count, name.

data()

);
stringVector->setString(0, count, name.

data()

);
ipaddrVector->setString(0, count, ipaddr.

data()

);
blobVector->setString(0, count, blob.

data()

);
decimal32Vector->setDouble(0, count, decimal32.

data()

);
decimal64Vector->setDouble(0, count, decimal64.

data()

);

vector <string> colName = {"cbool", "cchar", "cshort", "cint", "cdate", "cmonth", "ctime", "cminute", "csecond",
                           "cdatetime", "ctimestamp", "cnanotime",
                           "cnanotimestamp", "cfloat", "cdouble", "csymbol", "cstring", "cipaddr", "cblob",
                           "cdecimal32", "cdecimal64"};
vector <ConstantSP> colVector{boolVector, charVector, shortVector, intVector, dateVector, monthVector, timeVector,
                              minuteVector, secondVector,
                              datetimeVector, timestampVector, nanotimeVector, nanotimestampVector, floatVector,
                              doubleVector, symbolVector, stringVector,
...
boolvector->setInt(0, count, arrayValues.

data()

);
charvector->setInt(0, count, arrayValues.

data()

);
shortvector->setInt(0, count, arrayValues.

data()

);
intvector->setInt(0, count, arrayValues.

data()

);
longvector->setInt(0, count, arrayValues.

data()

);
floatvector->setInt(0, count, arrayValues.

data()

);
doublevector->setInt(0, count, arrayValues.

data()

);
datevector->setInt(0, count, arrayValues.

data()

);
timestampvector->setInt(0, count, arrayValues.

data()

);
datehourvector->setInt(0, count, arrayValues.

data()

);
datetimevector->setInt(0, count, arrayValues.

data()

);
timevector->setInt(0, count, arrayValues.

data()

);
minutevector->setInt(0, count, arrayValues.

data()

);
monthvector->setInt(0, count, arrayValues.

data()

);
secondvector->setInt(0, count, arrayValues.

data()

);
nanotimevector->setInt(0, count, arrayValues.

data()

);
nanotimestampVector->setInt(0, count, arrayValues.
...
VectorSP intArray = Util::createArrayVector(Index, intvector);
    ...
    //table insert
    vector <ConstantSP> colVector{timeVector, valueVector, boolArray, charArray, shortArray, longArray, intArray,
                                  floatArray, doubleArray,
                                  dateArray, timestampArray, datetimeArray, datehourArray, timeArray, minuteArray,
                                  monthArray,
