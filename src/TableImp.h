...
namespace dolphindb {
    ...
    public:
        ...
        virtual ConstantSP getWindow(int colStart, int colLength, int rowStart, int rowLength) const {
        ...
        virtual bool
        update(vector<ConstantSP> &values, const ConstantSP &indexSP, vector<string> &colNames, string &errMsg);
    ...
    private:
        ...
        bool
        internalUpdate(vector<ConstantSP> &values, const ConstantSP &indexSP, vector<string> &colNames, string &errMsg);
