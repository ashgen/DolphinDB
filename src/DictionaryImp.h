...
namespace dolphindb {
    ...
    public:
        ...
        virtual const string &getStringRef() const {
    ...
    public:
        ...
        AnyDictionary(const unordered_map<string, ConstantSP> &dict) : AbstractDictionary(DT_STRING, DT_ANY),
                                                                       dict_(dict) {}
    ...
    public:
        ...
        IntAnyDictionary(const unordered_map<int, ConstantSP> &dict, DATA_TYPE keyType = DT_INT) : AbstractDictionary(
                keyType, DT_ANY), dict_(dict) {}
    ...
    public:
        ...
        LongAnyDictionary(const unordered_map<long long, ConstantSP> &dict, DATA_TYPE keyType = DT_LONG)
                : AbstractDictionary(keyType, DT_ANY), dict_(dict) {}
    ...
    public:
        ...
        Int128AnyDictionary(const unordered_map<Guid, ConstantSP> &dict, DATA_TYPE keyType = DT_INT128)
                : AbstractDictionary(keyType, DT_ANY), dict_(dict) {}
