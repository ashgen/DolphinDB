...
namespace dolphindb {
    ...
    IncompatibleTypeException::IncompatibleTypeException(DATA_TYPE expected, DATA_TYPE actual) : expected_(expected),
                                                                                                 actual_(actual) {
        errMsg_.append("Incompatible type. Expected: " + Util::getDataTypeString(expected_) + ", Actual: " +
                       Util::getDataTypeString(actual_));
    }
