...
namespace dolphindb {
    ...
    public:
        ...
        static Constant *
        createNanoTimestamp(int year, int month, int day, int hour, int minute, int second, int nanosecond);

        static Constant *createNanoTimestamp(long long nanoseconds);

        static Constant *
        createTimestamp(int year, int month, int day, int hour, int minute, int second, int millisecond);
        ...
        static Table *
        createTable(const vector<string> &colNames, const vector<DATA_TYPE> &colTypes, INDEX size, INDEX capacity,
                    const vector<int> &extraParams = {});
        ...
        static Vector *
        createVector(DATA_TYPE type, INDEX size, INDEX capacity = 0, bool fast = true, int extraParam = 0,
                     void *data = 0, bool containNull = false);

        static Vector *createArrayVector(VectorSP index, VectorSP value);

        static Vector *
        createArrayVector(DATA_TYPE type, INDEX size, INDEX capacity = 0, bool fast = true, int extraParam = 0,
                          void *data = NULL, INDEX *pindex = NULL, bool containNull = false);

        static Vector *
        createMatrix(DATA_TYPE type, int cols, int rows, int colCapacity, int extraParam = 0, void *data = 0,
	...
	*/
        ...
        static Vector *
        createSymbolVector(const SymbolBaseSP &symbolBase, INDEX size, INDEX capacity = 0, bool fast = true,
        ...
        template<typename T>
        static ConstantSP
        createObject(DATA_TYPE dataType, T val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0) {
            SetOrThrowErrorInfo(errorCodeInfo, ErrorCodeInfo::EC_InvalidObject,
                                "It cannot be converted to " + getDataTypeString(dataType));
            return NULL;
        }

        static ConstantSP
        createObject(DATA_TYPE dataType, std::nullptr_t val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, Constant *val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, ConstantSP val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, bool val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, char val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, short val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, const char *val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, std::string val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, const unsigned char *val, ErrorCodeInfo *errorCodeInfo = NULL,
                     int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, unsigned char val[], ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, long long val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, long int val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, int val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, float val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, double val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, const void *val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);
	...
	*/
        static ConstantSP
        createObject(DATA_TYPE dataType, std::vector<std::nullptr_t> val, ErrorCodeInfo *errorCodeInfo = NULL,
                     int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, std::vector<Constant *> val, ErrorCodeInfo *errorCodeInfo = NULL,
                     int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, std::vector<ConstantSP> val, ErrorCodeInfo *errorCodeInfo = NULL,
                     int extraParam = 0);
        ...
        static ConstantSP
        createObject(DATA_TYPE dataType, std::vector<const char *> val, ErrorCodeInfo *errorCodeInfo = NULL,
                     int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, std::vector<std::string> val, ErrorCodeInfo *errorCodeInfo = NULL,
                     int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, std::vector<const unsigned char *> val, ErrorCodeInfo *errorCodeInfo = NULL,
                     int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, std::vector<long long> val, ErrorCodeInfo *errorCodeInfo = NULL,
                     int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, std::vector<long int> val, ErrorCodeInfo *errorCodeInfo = NULL,
                     int extraParam = 0);

        static ConstantSP
        createObject(DATA_TYPE dataType, std::vector<int> val, ErrorCodeInfo *errorCodeInfo = NULL, int extraParam = 0);
        ...
        static ConstantSP
        createObject(DATA_TYPE dataType, std::vector<const void *> val, ErrorCodeInfo *errorCodeInfo = NULL,
                     int extraParam = 0);

        static ConstantSP
        createValue(DATA_TYPE dataType, long long val, const char *pTypeName, ErrorCodeInfo *errorCodeInfo = NULL,
                    int extraParam = 0);
        ...
        static void enumBoolVector(const VectorSP &pVector,
                                   std::function<bool(const char *pbuf, INDEX startIndex, INDEX size)> func,
                                   INDEX offset = 0) {
            enumDdbVector<char>(pVector, &Vector::getBoolConst, func, offset);
        }

        static void
        enumIntVector(const VectorSP &pVector, std::function<bool(const int *pbuf, INDEX startIndex, int length)> func,
                      INDEX offset = 0) {
            enumDdbVector<int>(pVector, &Vector::getIntConst, func, offset);
        }

        static void enumShortVector(const VectorSP &pVector,
                                    std::function<bool(const short *pbuf, INDEX startIndex, int length)> func,
                                    INDEX offset = 0) {
            enumDdbVector<short>(pVector, &Vector::getShortConst, func, offset);
        }

        static void enumCharVector(const VectorSP &pVector,
                                   std::function<bool(const char *pbuf, INDEX startIndex, int length)> func,
                                   INDEX offset = 0) {
            enumDdbVector<char>(pVector, &Vector::getCharConst, func, offset);
        }

        static void enumLongVector(const VectorSP &pVector,
                                   std::function<bool(const long long *pbuf, INDEX startIndex, int length)> func,
                                   INDEX offset = 0) {
            enumDdbVector<long long>(pVector, &Vector::getLongConst, func, offset);
        }

        static void enumFloatVector(const VectorSP &pVector,
                                    std::function<bool(const float *pbuf, INDEX startIndex, int length)> func,
                                    INDEX offset = 0) {
            enumDdbVector<float>(pVector, &Vector::getFloatConst, func, offset);
        }

        static void enumDoubleVector(const VectorSP &pVector,
                                     std::function<bool(const double *pbuf, INDEX startIndex, int length)> func,
                                     INDEX offset = 0) {
            enumDdbVector<double>(pVector, &Vector::getDoubleConst, func, offset);
        }

        static void
        enumStringVector(const VectorSP &pVector, std::function<bool(string **pbuf, INDEX startIndex, int length)> func,
                         INDEX offset = 0) {
        ...
        static void enumInt128Vector(const VectorSP &pVector,
                                     std::function<bool(const Guid *pbuf, INDEX startIndex, int length)> func,
                                     INDEX offset = 0) {
            enumBinaryVector<Guid>(pVector, func, offset);
        }

        static void enumDecimal32Vector(const VectorSP &pVector,
                                        std::function<bool(const int32_t *pbuf, INDEX startIndex, int length)> func,
                                        INDEX offset = 0) {
            enumBinaryVector<int32_t>(pVector, func, offset);
        }

        static void enumDecimal64Vector(const VectorSP &pVector,
                                        std::function<bool(const int64_t *pbuf, INDEX startIndex, int length)> func,
                                        INDEX offset = 0) {
    ...
    private:
        template<class T>
        static void
        enumBinaryVector(const VectorSP &pVector, std::function<bool(const T *pbuf, INDEX startIndex, int length)> func,
                         INDEX offset = 0) {
            ...
            while (leftSize > 0) {
                ...
                if (size > Util::BUF_SIZE)
                    size = Util::BUF_SIZE;
                pbuf = (const T *) pVector->getBinaryConst(startIndex, size, sizeof(T),
        ...
        static void enumDdbVector(const VectorSP &pVector,
                                  ...
                                  std::function<bool(const T *buf, INDEX startIndex, int length)> func,
                                  INDEX offset = 0) {
    ...
    public:
        ResultSet(const TableSP &table)
            ...
            for (int i = 0; i < cols_; i++) {
                ...
                switch (type) {
                    case DT_BOOL:
                        column_[i].charCol = new Column<char>(pVector,
                                                              [=](const VectorSP &pVector, INDEX position, int len,
                                                                  char *buf) {
                    ...
                    case DT_CHAR:
                        ...
                        break;
                    case DT_SHORT:
                        column_[i].shortCol = new Column<short>(pVector,
                                                                [=](const VectorSP &pVector, INDEX position, int len,
                                                                    short *buf) {
                    ...
                    case DT_INT:
                        if (pVector->getType() == DT_SYMBOL) {
                            column_[i].stringCol = new Column<string *>(pVector,
                                                                        [=](const VectorSP &pVector, INDEX position,
                                                                            int len, string **buf) {
                                                                            return pVector->getStringConst(position,
                                                                                                           len, buf);
                                                                        });
                        } else {
                            column_[i].intCol = new Column<int>(pVector,
                                                                [=](const VectorSP &pVector, INDEX position, int len,
                                                                    int *buf) {
                        ...
                        break;
                    case DT_LONG:
                        column_[i].longCol = new Column<long long>(pVector,
                                                                   [=](const VectorSP &pVector, INDEX position, int len,
                                                                       long long *buf) {
                        ...
                        break;
                    case DT_FLOAT:
                        column_[i].floatCol = new Column<float>(pVector,
                                                                [=](const VectorSP &pVector, INDEX position, int len,
                                                                    float *buf) {
                        ...
                        break;
                    case DT_DOUBLE:
                        column_[i].doubleCol = new Column<double>(pVector,
                                                                  [=](const VectorSP &pVector, INDEX position, int len,
                                                                      double *buf) {
                                                                      return pVector->getDoubleConst(position, len,
                                                                                                     buf);
                                                                  });
                        break;
                    case DT_BLOB:
                    case DT_STRING:
                        column_[i].stringCol = new Column<string *>(pVector,
                                                                    [=](const VectorSP &pVector, INDEX position,
                                                                        int len, string **buf) {
                                                                        return pVector->getStringConst(position, len,
                                                                                                       buf);
                                                                    });
                        break;
                    case DT_INT128:
                        column_[i].int128Col = new Column<Guid>(pVector,
                                                                [=](const VectorSP &pVector, INDEX position, int len,
                                                                    Guid *buf) {
                                                                    return (const Guid *) pVector->getBinaryConst(
                                                                            position, len, sizeof(Guid),
                                                                            (unsigned char *) buf);
                                                                });
                        break;
                    case DT_DECIMAL32:
                        column_[i].decimal32Col = new Column<int32_t>(pVector,
                                                                      [=](const VectorSP &pVector, INDEX position,
                                                                          int len, int32_t *buf) {
                                                                          return (const int32_t *) pVector->getBinaryConst(
                                                                                  position, len, sizeof(int32_t),
                                                                                  (unsigned char *) buf);
                                                                      });
                        break;
                    case DT_DECIMAL64:
                        column_[i].decimal64Col = new Column<int64_t>(pVector,
                                                                      [=](const VectorSP &pVector, INDEX position,
                                                                          int len, int64_t *buf) {
                                                                          return (const int64_t *) pVector->getBinaryConst(
                                                                                  position, len, sizeof(int64_t),
                                                                                  (unsigned char *) buf);
                                                                      });
                        break;
                    default:
                        throw RuntimeException(
                                "ResultSet doesn't support data type " + Util::getDataTypeString(pVector->getType()));
                        break;
                }
            }
        }
    ...
    class DdbVector {
    public:
        DdbVector(int size, int capacity = 0) : size_(size), capacity_(capacity), dataNeedRelease_(true),
                                                containNull_(false) {
            if (capacity_ < size_)
                capacity_ = size_;
            if (capacity_ < 1) {
        ...
        DdbVector(T *data, int size, int capacity = 0) : data_(data), size_(size), capacity_(capacity),
                                                         dataNeedRelease_(true), containNull_(false) {
            if (capacity_ < size_)
                capacity_ = size_;
        }
